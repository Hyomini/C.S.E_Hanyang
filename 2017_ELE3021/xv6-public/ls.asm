...
fmtname(char *path)
{
  ...
  61:	c7 04 24 bc 0f 00 00 	movl   $0xfbc,(%esp)
  ...
  8c:	05 bc 0f 00 00       	add    $0xfbc,%eax
  ...
  return buf;
  a5:	b8 bc 0f 00 00       	mov    $0xfbc,%eax
}
...
ls(char *path)
{
  ...
  df:	c7 44 24 04 3f 0c 00 	movl   $0xc3f,0x4(%esp)
  e6:	00 
 ...
 118:	c7 44 24 04 53 0c 00 	movl   $0xc53,0x4(%esp)
 11f:	00 
 ...
 183:	c7 44 24 04 67 0c 00 	movl   $0xc67,0x4(%esp)
 18a:	00 
 ...
 1b1:	c7 44 24 04 74 0c 00 	movl   $0xc74,0x4(%esp)
 1b8:	00 
 ...
 269:	c7 44 24 04 53 0c 00 	movl   $0xc53,0x4(%esp)
 270:	00 
 ...
 2b3:	c7 44 24 04 67 0c 00 	movl   $0xc67,0x4(%esp)
 2ba:	00 
...
main(int argc, char *argv[])
{
 ...
 311:	7f 11                	jg     324 <main+0x20>
    ls(".");
 313:	c7 04 24 87 0c 00 00 	movl   $0xc87,(%esp)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 714:	0f b6 80 a8 0f 00 00 	movzbl 0xfa8(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 871:	75 09                	jne    87c <printf+0x101>
          s = "(null)";
 873:	c7 45 f4 89 0c 00 00 	movl   $0xc89,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 93d:	a1 d4 0f 00 00       	mov    0xfd4,%eax
...
free(void *ap)
{
 ...
 a08:	a3 d4 0f 00 00       	mov    %eax,0xfd4
}
 a0d:	c9                   	leave  
 a0e:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 a5b:	e8 ce fe ff ff       	call   92e <free>
  return freep;
 a60:	a1 d4 0f 00 00       	mov    0xfd4,%eax
}
 a65:	c9                   	leave  
 a66:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 a79:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 a7c:	a1 d4 0f 00 00       	mov    0xfd4,%eax
 a81:	89 45 f0             	mov    %eax,-0x10(%ebp)
 a84:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 a88:	75 23                	jne    aad <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 a8a:	c7 45 f0 cc 0f 00 00 	movl   $0xfcc,-0x10(%ebp)
 a91:	8b 45 f0             	mov    -0x10(%ebp),%eax
 a94:	a3 d4 0f 00 00       	mov    %eax,0xfd4
 a99:	a1 d4 0f 00 00       	mov    0xfd4,%eax
 a9e:	a3 cc 0f 00 00       	mov    %eax,0xfcc
    base.s.size = 0;
 aa3:	c7 05 d0 0f 00 00 00 	movl   $0x0,0xfd0
 aaa:	00 00 00 
  }
 ...
 b00:	a3 d4 0f 00 00       	mov    %eax,0xfd4
      return (void*)(p + 1);
 ...
 b0b:	eb 38                	jmp    b45 <malloc+0xde>
    ...
    if(p == freep)
 b0d:	a1 d4 0f 00 00       	mov    0xfd4,%eax
...
00000c23 <thread_exit>:

void thread_exit(void *retval)
{
 c23:	55                   	push   %ebp
 c24:	89 e5                	mov    %esp,%ebp
 c26:	83 ec 08             	sub    $0x8,%esp
    proc->retval = retval;
 c29:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
 c2f:	8b 55 08             	mov    0x8(%ebp),%edx
 c32:	89 90 88 00 00 00    	mov    %edx,0x88(%eax)
    thexit();
 c38:	e8 56 fa ff ff       	call   693 <thexit>
}
 c3d:	c9                   	leave  
 c3e:	c3                   	ret    
