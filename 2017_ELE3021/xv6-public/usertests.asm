...
iputtest(void)
{
  ...
  printf(stdout, "iput test\n");
       ...
       b:	c7 44 24 04 7e 46 00 	movl   $0x467e,0x4(%esp)
      12:	00 
      13:	89 04 24             	mov    %eax,(%esp)
      16:	e8 87 41 00 00       	call   41a2 <printf>

  if(mkdir("iputdir") < 0){
      1b:	c7 04 24 89 46 00 00 	movl   $0x4689,(%esp)
      22:	e8 2b 40 00 00       	call   4052 <mkdir>
      27:	85 c0                	test   %eax,%eax
      29:	79 1a                	jns    45 <iputtest+0x45>
    printf(stdout, "mkdir failed\n");
      2b:	a1 44 66 00 00       	mov    0x6644,%eax
      30:	c7 44 24 04 91 46 00 	movl   $0x4691,0x4(%esp)
      37:	00 
      38:	89 04 24             	mov    %eax,(%esp)
      3b:	e8 62 41 00 00       	call   41a2 <printf>
    exit();
      40:	e8 a5 3f 00 00       	call   3fea <exit>
  }
  if(chdir("iputdir") < 0){
      45:	c7 04 24 89 46 00 00 	movl   $0x4689,(%esp)
      4c:	e8 09 40 00 00       	call   405a <chdir>
      51:	85 c0                	test   %eax,%eax
      53:	79 1a                	jns    6f <iputtest+0x6f>
    printf(stdout, "chdir iputdir failed\n");
      55:	a1 44 66 00 00       	mov    0x6644,%eax
      5a:	c7 44 24 04 9f 46 00 	movl   $0x469f,0x4(%esp)
      61:	00 
      62:	89 04 24             	mov    %eax,(%esp)
      65:	e8 38 41 00 00       	call   41a2 <printf>
    exit();
      6a:	e8 7b 3f 00 00       	call   3fea <exit>
  }
  if(unlink("../iputdir") < 0){
      6f:	c7 04 24 b5 46 00 00 	movl   $0x46b5,(%esp)
      76:	e8 bf 3f 00 00       	call   403a <unlink>
      7b:	85 c0                	test   %eax,%eax
      7d:	79 1a                	jns    99 <iputtest+0x99>
    printf(stdout, "unlink ../iputdir failed\n");
      7f:	a1 44 66 00 00       	mov    0x6644,%eax
      84:	c7 44 24 04 c0 46 00 	movl   $0x46c0,0x4(%esp)
      8b:	00 
      8c:	89 04 24             	mov    %eax,(%esp)
      8f:	e8 0e 41 00 00       	call   41a2 <printf>
    exit();
      94:	e8 51 3f 00 00       	call   3fea <exit>
  }
  if(chdir("/") < 0){
      99:	c7 04 24 da 46 00 00 	movl   $0x46da,(%esp)
      a0:	e8 b5 3f 00 00       	call   405a <chdir>
      a5:	85 c0                	test   %eax,%eax
      a7:	79 1a                	jns    c3 <iputtest+0xc3>
    printf(stdout, "chdir / failed\n");
      a9:	a1 44 66 00 00       	mov    0x6644,%eax
      ae:	c7 44 24 04 dc 46 00 	movl   $0x46dc,0x4(%esp)
      b5:	00 
      b6:	89 04 24             	mov    %eax,(%esp)
      b9:	e8 e4 40 00 00       	call   41a2 <printf>
    exit();
      be:	e8 27 3f 00 00       	call   3fea <exit>
  }
  printf(stdout, "iput test ok\n");
      c3:	a1 44 66 00 00       	mov    0x6644,%eax
      c8:	c7 44 24 04 ec 46 00 	movl   $0x46ec,0x4(%esp)
      cf:	00 
      d0:	89 04 24             	mov    %eax,(%esp)
      d3:	e8 ca 40 00 00       	call   41a2 <printf>
}
      d8:	c9                   	leave  
      d9:	c3                   	ret    
...
exitiputtest(void)
{
  ...
  printf(stdout, "exitiput test\n");
      e0:	a1 44 66 00 00       	mov    0x6644,%eax
      e5:	c7 44 24 04 fa 46 00 	movl   $0x46fa,0x4(%esp)
      ec:	00 
      ed:	89 04 24             	mov    %eax,(%esp)
      f0:	e8 ad 40 00 00       	call   41a2 <printf>
  ...
  if(pid < 0){
    ...
    printf(stdout, "fork failed\n");
     103:	a1 44 66 00 00       	mov    0x6644,%eax
     108:	c7 44 24 04 09 47 00 	movl   $0x4709,0x4(%esp)
     10f:	00 
     110:	89 04 24             	mov    %eax,(%esp)
     113:	e8 8a 40 00 00       	call   41a2 <printf>
    exit();
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     127:	c7 04 24 89 46 00 00 	movl   $0x4689,(%esp)
     12e:	e8 1f 3f 00 00       	call   4052 <mkdir>
     133:	85 c0                	test   %eax,%eax
     135:	79 1a                	jns    151 <exitiputtest+0x77>
      printf(stdout, "mkdir failed\n");
     137:	a1 44 66 00 00       	mov    0x6644,%eax
     13c:	c7 44 24 04 91 46 00 	movl   $0x4691,0x4(%esp)
     143:	00 
     144:	89 04 24             	mov    %eax,(%esp)
     147:	e8 56 40 00 00       	call   41a2 <printf>
      exit();
     14c:	e8 99 3e 00 00       	call   3fea <exit>
    }
    if(chdir("iputdir") < 0){
     151:	c7 04 24 89 46 00 00 	movl   $0x4689,(%esp)
     158:	e8 fd 3e 00 00       	call   405a <chdir>
     15d:	85 c0                	test   %eax,%eax
     15f:	79 1a                	jns    17b <exitiputtest+0xa1>
      printf(stdout, "child chdir failed\n");
     161:	a1 44 66 00 00       	mov    0x6644,%eax
     166:	c7 44 24 04 16 47 00 	movl   $0x4716,0x4(%esp)
     16d:	00 
     16e:	89 04 24             	mov    %eax,(%esp)
     171:	e8 2c 40 00 00       	call   41a2 <printf>
      exit();
     176:	e8 6f 3e 00 00       	call   3fea <exit>
    }
    if(unlink("../iputdir") < 0){
     17b:	c7 04 24 b5 46 00 00 	movl   $0x46b5,(%esp)
     182:	e8 b3 3e 00 00       	call   403a <unlink>
     187:	85 c0                	test   %eax,%eax
     189:	79 1a                	jns    1a5 <exitiputtest+0xcb>
      printf(stdout, "unlink ../iputdir failed\n");
     18b:	a1 44 66 00 00       	mov    0x6644,%eax
     190:	c7 44 24 04 c0 46 00 	movl   $0x46c0,0x4(%esp)
     197:	00 
     198:	89 04 24             	mov    %eax,(%esp)
     19b:	e8 02 40 00 00       	call   41a2 <printf>
      exit();
  ...
  printf(stdout, "exitiput test ok\n");
     1af:	a1 44 66 00 00       	mov    0x6644,%eax
     1b4:	c7 44 24 04 2a 47 00 	movl   $0x472a,0x4(%esp)
     1bb:	00 
     1bc:	89 04 24             	mov    %eax,(%esp)
     1bf:	e8 de 3f 00 00       	call   41a2 <printf>
}
     1c4:	c9                   	leave  
     1c5:	c3                   	ret    
...
openiputtest(void)
{
  ...
  printf(stdout, "openiput test\n");
     1cc:	a1 44 66 00 00       	mov    0x6644,%eax
     1d1:	c7 44 24 04 3c 47 00 	movl   $0x473c,0x4(%esp)
     1d8:	00 
     1d9:	89 04 24             	mov    %eax,(%esp)
     1dc:	e8 c1 3f 00 00       	call   41a2 <printf>
  if(mkdir("oidir") < 0){
     1e1:	c7 04 24 4b 47 00 00 	movl   $0x474b,(%esp)
     1e8:	e8 65 3e 00 00       	call   4052 <mkdir>
     1ed:	85 c0                	test   %eax,%eax
     1ef:	79 1a                	jns    20b <openiputtest+0x45>
    printf(stdout, "mkdir oidir failed\n");
     1f1:	a1 44 66 00 00       	mov    0x6644,%eax
     1f6:	c7 44 24 04 51 47 00 	movl   $0x4751,0x4(%esp)
     1fd:	00 
     1fe:	89 04 24             	mov    %eax,(%esp)
     201:	e8 9c 3f 00 00       	call   41a2 <printf>
    exit();
  ...
  if(pid < 0){
    ...
    printf(stdout, "fork failed\n");
     219:	a1 44 66 00 00       	mov    0x6644,%eax
     21e:	c7 44 24 04 09 47 00 	movl   $0x4709,0x4(%esp)
     225:	00 
     226:	89 04 24             	mov    %eax,(%esp)
     229:	e8 74 3f 00 00       	call   41a2 <printf>
    exit();
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     240:	00 
     241:	c7 04 24 4b 47 00 00 	movl   $0x474b,(%esp)
    ...
    if(fd >= 0){
     ...
     256:	a1 44 66 00 00       	mov    0x6644,%eax
     25b:	c7 44 24 04 68 47 00 	movl   $0x4768,0x4(%esp)
     262:	00 
     263:	89 04 24             	mov    %eax,(%esp)
     266:	e8 37 3f 00 00       	call   41a2 <printf>
      exit();
  ...
  if(unlink("oidir") != 0){
     281:	c7 04 24 4b 47 00 00 	movl   $0x474b,(%esp)
     288:	e8 ad 3d 00 00       	call   403a <unlink>
     28d:	85 c0                	test   %eax,%eax
     28f:	74 1a                	je     2ab <openiputtest+0xe5>
    printf(stdout, "unlink failed\n");
     291:	a1 44 66 00 00       	mov    0x6644,%eax
     296:	c7 44 24 04 8c 47 00 	movl   $0x478c,0x4(%esp)
     29d:	00 
     29e:	89 04 24             	mov    %eax,(%esp)
     2a1:	e8 fc 3e 00 00       	call   41a2 <printf>
    exit();
  ...
  printf(stdout, "openiput test ok\n");
     2b0:	a1 44 66 00 00       	mov    0x6644,%eax
     2b5:	c7 44 24 04 9b 47 00 	movl   $0x479b,0x4(%esp)
     2bc:	00 
     2bd:	89 04 24             	mov    %eax,(%esp)
     2c0:	e8 dd 3e 00 00       	call   41a2 <printf>
}
     2c5:	c9                   	leave  
     2c6:	c3                   	ret    
...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
     2cd:	a1 44 66 00 00       	mov    0x6644,%eax
     2d2:	c7 44 24 04 ad 47 00 	movl   $0x47ad,0x4(%esp)
     2d9:	00 
     2da:	89 04 24             	mov    %eax,(%esp)
     2dd:	e8 c0 3e 00 00       	call   41a2 <printf>
  fd = open("echo", 0);
     2e2:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
     2e9:	00 
     2ea:	c7 04 24 68 46 00 00 	movl   $0x4668,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "open echo failed!\n");
     2ff:	a1 44 66 00 00       	mov    0x6644,%eax
     304:	c7 44 24 04 b8 47 00 	movl   $0x47b8,0x4(%esp)
     30b:	00 
     30c:	89 04 24             	mov    %eax,(%esp)
     30f:	e8 8e 3e 00 00       	call   41a2 <printf>
    exit();
  ...
  fd = open("doesnotexist", 0);
     ...
     32b:	00 
     32c:	c7 04 24 cb 47 00 00 	movl   $0x47cb,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
     341:	a1 44 66 00 00       	mov    0x6644,%eax
     346:	c7 44 24 04 d8 47 00 	movl   $0x47d8,0x4(%esp)
     34d:	00 
     34e:	89 04 24             	mov    %eax,(%esp)
     351:	e8 4c 3e 00 00       	call   41a2 <printf>
    exit();
     356:	e8 8f 3c 00 00       	call   3fea <exit>
  }
  printf(stdout, "open test ok\n");
     35b:	a1 44 66 00 00       	mov    0x6644,%eax
     360:	c7 44 24 04 f6 47 00 	movl   $0x47f6,0x4(%esp)
     367:	00 
     368:	89 04 24             	mov    %eax,(%esp)
     36b:	e8 32 3e 00 00       	call   41a2 <printf>
}
     370:	c9                   	leave  
     371:	c3                   	ret    
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
     378:	a1 44 66 00 00       	mov    0x6644,%eax
     37d:	c7 44 24 04 04 48 00 	movl   $0x4804,0x4(%esp)
     384:	00 
     385:	89 04 24             	mov    %eax,(%esp)
     388:	e8 15 3e 00 00       	call   41a2 <printf>
  fd = open("small", O_CREATE|O_RDWR);
     38d:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     394:	00 
     395:	c7 04 24 15 48 00 00 	movl   $0x4815,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     3aa:	a1 44 66 00 00       	mov    0x6644,%eax
     3af:	c7 44 24 04 1b 48 00 	movl   $0x481b,0x4(%esp)
     3b6:	00 
     3b7:	89 04 24             	mov    %eax,(%esp)
     3ba:	e8 e3 3d 00 00       	call   41a2 <printf>
  } else {
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: creat small failed!\n");
     3cb:	a1 44 66 00 00       	mov    0x6644,%eax
     3d0:	c7 44 24 04 36 48 00 	movl   $0x4836,0x4(%esp)
     3d7:	00 
     3d8:	89 04 24             	mov    %eax,(%esp)
     3db:	e8 c2 3d 00 00       	call   41a2 <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     3ec:	00 
     3ed:	c7 44 24 04 52 48 00 	movl   $0x4852,0x4(%esp)
     3f4:	00 
     ...
     405:	a1 44 66 00 00       	mov    0x6644,%eax
     40a:	8b 55 f4             	mov    -0xc(%ebp),%edx
     40d:	89 54 24 08          	mov    %edx,0x8(%esp)
     411:	c7 44 24 04 60 48 00 	movl   $0x4860,0x4(%esp)
     418:	00 
     419:	89 04 24             	mov    %eax,(%esp)
     41c:	e8 81 3d 00 00       	call   41a2 <printf>
      exit();
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     42d:	00 
     42e:	c7 44 24 04 84 48 00 	movl   $0x4884,0x4(%esp)
     435:	00 
     ...
     446:	a1 44 66 00 00       	mov    0x6644,%eax
     44b:	8b 55 f4             	mov    -0xc(%ebp),%edx
     44e:	89 54 24 08          	mov    %edx,0x8(%esp)
     452:	c7 44 24 04 90 48 00 	movl   $0x4890,0x4(%esp)
     459:	00 
     45a:	89 04 24             	mov    %eax,(%esp)
     45d:	e8 40 3d 00 00       	call   41a2 <printf>
      exit();
  ...
  printf(stdout, "writes ok\n");
     475:	a1 44 66 00 00       	mov    0x6644,%eax
     47a:	c7 44 24 04 b4 48 00 	movl   $0x48b4,0x4(%esp)
     481:	00 
     482:	89 04 24             	mov    %eax,(%esp)
     485:	e8 18 3d 00 00       	call   41a2 <printf>
  close(fd);
  ...
  fd = open("small", O_RDONLY);
     ...
     49c:	00 
     49d:	c7 04 24 15 48 00 00 	movl   $0x4815,(%esp)
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     4b2:	a1 44 66 00 00       	mov    0x6644,%eax
     4b7:	c7 44 24 04 bf 48 00 	movl   $0x48bf,0x4(%esp)
     4be:	00 
     4bf:	89 04 24             	mov    %eax,(%esp)
     4c2:	e8 db 3c 00 00       	call   41a2 <printf>
  } else {
  ...
  i = read(fd, buf, 2000);
     ...
     4ce:	00 
     4cf:	c7 44 24 04 20 8e 00 	movl   $0x8e20,0x4(%esp)
     4d6:	00 
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: open small failed!\n");
     4f0:	a1 44 66 00 00       	mov    0x6644,%eax
     4f5:	c7 44 24 04 d8 48 00 	movl   $0x48d8,0x4(%esp)
     4fc:	00 
     4fd:	89 04 24             	mov    %eax,(%esp)
     500:	e8 9d 3c 00 00       	call   41a2 <printf>
    exit();
  ...
  if(i == 2000){
    printf(stdout, "read succeeded ok\n");
     50a:	a1 44 66 00 00       	mov    0x6644,%eax
     50f:	c7 44 24 04 f3 48 00 	movl   $0x48f3,0x4(%esp)
     516:	00 
     517:	89 04 24             	mov    %eax,(%esp)
     51a:	e8 83 3c 00 00       	call   41a2 <printf>
  } else {
  ...
  if(unlink("small") < 0){
     52a:	c7 04 24 15 48 00 00 	movl   $0x4815,(%esp)
  ...
  if(i == 2000){
    ...
    printf(stdout, "read failed\n");
     53c:	a1 44 66 00 00       	mov    0x6644,%eax
     541:	c7 44 24 04 06 49 00 	movl   $0x4906,0x4(%esp)
     548:	00 
     549:	89 04 24             	mov    %eax,(%esp)
     54c:	e8 51 3c 00 00       	call   41a2 <printf>
    exit();
  ...
  if(unlink("small") < 0){
    printf(stdout, "unlink small failed\n");
     556:	a1 44 66 00 00       	mov    0x6644,%eax
     55b:	c7 44 24 04 13 49 00 	movl   $0x4913,0x4(%esp)
     562:	00 
     563:	89 04 24             	mov    %eax,(%esp)
     566:	e8 37 3c 00 00       	call   41a2 <printf>
    exit();
     56b:	e8 7a 3a 00 00       	call   3fea <exit>
  }
  printf(stdout, "small file test ok\n");
     570:	a1 44 66 00 00       	mov    0x6644,%eax
     575:	c7 44 24 04 28 49 00 	movl   $0x4928,0x4(%esp)
     57c:	00 
     57d:	89 04 24             	mov    %eax,(%esp)
     580:	e8 1d 3c 00 00       	call   41a2 <printf>
}
     585:	c9                   	leave  
     586:	c3                   	ret    
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     58d:	a1 44 66 00 00       	mov    0x6644,%eax
     592:	c7 44 24 04 3c 49 00 	movl   $0x493c,0x4(%esp)
     599:	00 
     59a:	89 04 24             	mov    %eax,(%esp)
     59d:	e8 00 3c 00 00       	call   41a2 <printf>

  fd = open("big", O_CREATE|O_RDWR);
     5a2:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     5a9:	00 
     5aa:	c7 04 24 4c 49 00 00 	movl   $0x494c,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: creat big failed!\n");
     5bf:	a1 44 66 00 00       	mov    0x6644,%eax
     5c4:	c7 44 24 04 50 49 00 	movl   $0x4950,0x4(%esp)
     5cb:	00 
     5cc:	89 04 24             	mov    %eax,(%esp)
     5cf:	e8 ce 3b 00 00       	call   41a2 <printf>
    exit();
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     60e:	a1 44 66 00 00       	mov    0x6644,%eax
     613:	8b 55 f4             	mov    -0xc(%ebp),%edx
     616:	89 54 24 08          	mov    %edx,0x8(%esp)
     61a:	c7 44 24 04 6a 49 00 	movl   $0x496a,0x4(%esp)
     621:	00 
     622:	89 04 24             	mov    %eax,(%esp)
     625:	e8 78 3b 00 00       	call   41a2 <printf>
      exit();
  ...
  for(i = 0; i < MAXFILE; i++){
     ...
     636:	3d 8a 40 00 00       	cmp    $0x408a,%eax
  ...
  fd = open("big", O_RDONLY);
     ...
     64f:	00 
     650:	c7 04 24 4c 49 00 00 	movl   $0x494c,(%esp)
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: open big failed!\n");
     665:	a1 44 66 00 00       	mov    0x6644,%eax
     66a:	c7 44 24 04 88 49 00 	movl   $0x4988,0x4(%esp)
     671:	00 
     672:	89 04 24             	mov    %eax,(%esp)
     675:	e8 28 3b 00 00       	call   41a2 <printf>
    exit();
  ...
  for(;;){
    i = read(fd, buf, 512);
     ...
     68d:	00 
     68e:	c7 44 24 04 20 8e 00 	movl   $0x8e20,0x4(%esp)
     695:	00 
    ...
    if(i == 0){
     ...
     6a8:	75 4c                	jne    6f6 <writetest1+0x16f>
      if(n == MAXFILE - 1){
     6aa:	81 7d f0 8a 40 00 00 	cmpl   $0x408a,-0x10(%ebp)
     6b1:	75 21                	jne    6d4 <writetest1+0x14d>
        printf(stdout, "read only %d blocks from big", n);
     6b3:	a1 44 66 00 00       	mov    0x6644,%eax
     6b8:	8b 55 f0             	mov    -0x10(%ebp),%edx
     6bb:	89 54 24 08          	mov    %edx,0x8(%esp)
     6bf:	c7 44 24 04 a1 49 00 	movl   $0x49a1,0x4(%esp)
     6c6:	00 
     6c7:	89 04 24             	mov    %eax,(%esp)
     6ca:	e8 d3 3a 00 00       	call   41a2 <printf>
        exit();
  ...
  if(unlink("big") < 0){
     6e0:	c7 04 24 4c 49 00 00 	movl   $0x494c,(%esp)
  ...
  if(unlink("big") < 0){
    printf(stdout, "unlink big failed\n");
     761:	a1 44 66 00 00       	mov    0x6644,%eax
     766:	c7 44 24 04 f0 49 00 	movl   $0x49f0,0x4(%esp)
     76d:	00 
     76e:	89 04 24             	mov    %eax,(%esp)
     771:	e8 2c 3a 00 00       	call   41a2 <printf>
    exit();
     776:	e8 6f 38 00 00       	call   3fea <exit>
  }
  printf(stdout, "big files ok\n");
     77b:	a1 44 66 00 00       	mov    0x6644,%eax
     780:	c7 44 24 04 03 4a 00 	movl   $0x4a03,0x4(%esp)
     787:	00 
     788:	89 04 24             	mov    %eax,(%esp)
     78b:	e8 12 3a 00 00       	call   41a2 <printf>
}
     790:	c9                   	leave  
     791:	c3                   	ret    
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     798:	a1 44 66 00 00       	mov    0x6644,%eax
     79d:	c7 44 24 04 14 4a 00 	movl   $0x4a14,0x4(%esp)
     7a4:	00 
     7a5:	89 04 24             	mov    %eax,(%esp)
     7a8:	e8 f5 39 00 00       	call   41a2 <printf>

  name[0] = 'a';
     7ad:	c6 05 20 ae 00 00 61 	movb   $0x61,0xae20
  name[2] = '\0';
     7b4:	c6 05 22 ae 00 00 00 	movb   $0x0,0xae22
  for(i = 0; i < 52; i++){
    ...
    name[1] = '0' + i;
     ...
     7ca:	a2 21 ae 00 00       	mov    %al,0xae21
    fd = open(name, O_CREATE|O_RDWR);
     7cf:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     7d6:	00 
     7d7:	c7 04 24 20 ae 00 00 	movl   $0xae20,(%esp)
  ...
  name[0] = 'a';
     7fb:	c6 05 20 ae 00 00 61 	movb   $0x61,0xae20
  name[2] = '\0';
     802:	c6 05 22 ae 00 00 00 	movb   $0x0,0xae22
  for(i = 0; i < 52; i++){
    ...
    name[1] = '0' + i;
     ...
     818:	a2 21 ae 00 00       	mov    %al,0xae21
    unlink(name);
     81d:	c7 04 24 20 ae 00 00 	movl   $0xae20,(%esp)
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     833:	a1 44 66 00 00       	mov    0x6644,%eax
     838:	c7 44 24 04 3c 4a 00 	movl   $0x4a3c,0x4(%esp)
     83f:	00 
     840:	89 04 24             	mov    %eax,(%esp)
     843:	e8 5a 39 00 00       	call   41a2 <printf>
}
     848:	c9                   	leave  
     849:	c3                   	ret    
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     850:	a1 44 66 00 00       	mov    0x6644,%eax
     855:	c7 44 24 04 62 4a 00 	movl   $0x4a62,0x4(%esp)
     85c:	00 
     85d:	89 04 24             	mov    %eax,(%esp)
     860:	e8 3d 39 00 00       	call   41a2 <printf>

  if(mkdir("dir0") < 0){
     865:	c7 04 24 6e 4a 00 00 	movl   $0x4a6e,(%esp)
     86c:	e8 e1 37 00 00       	call   4052 <mkdir>
     871:	85 c0                	test   %eax,%eax
     873:	79 1a                	jns    88f <dirtest+0x45>
    printf(stdout, "mkdir failed\n");
     875:	a1 44 66 00 00       	mov    0x6644,%eax
     87a:	c7 44 24 04 91 46 00 	movl   $0x4691,0x4(%esp)
     881:	00 
     882:	89 04 24             	mov    %eax,(%esp)
     885:	e8 18 39 00 00       	call   41a2 <printf>
    exit();
     88a:	e8 5b 37 00 00       	call   3fea <exit>
  }

  if(chdir("dir0") < 0){
     88f:	c7 04 24 6e 4a 00 00 	movl   $0x4a6e,(%esp)
     896:	e8 bf 37 00 00       	call   405a <chdir>
     89b:	85 c0                	test   %eax,%eax
     89d:	79 1a                	jns    8b9 <dirtest+0x6f>
    printf(stdout, "chdir dir0 failed\n");
     89f:	a1 44 66 00 00       	mov    0x6644,%eax
     8a4:	c7 44 24 04 73 4a 00 	movl   $0x4a73,0x4(%esp)
     8ab:	00 
     8ac:	89 04 24             	mov    %eax,(%esp)
     8af:	e8 ee 38 00 00       	call   41a2 <printf>
    exit();
     8b4:	e8 31 37 00 00       	call   3fea <exit>
  }

  if(chdir("..") < 0){
     8b9:	c7 04 24 86 4a 00 00 	movl   $0x4a86,(%esp)
     8c0:	e8 95 37 00 00       	call   405a <chdir>
     8c5:	85 c0                	test   %eax,%eax
     8c7:	79 1a                	jns    8e3 <dirtest+0x99>
    printf(stdout, "chdir .. failed\n");
     8c9:	a1 44 66 00 00       	mov    0x6644,%eax
     8ce:	c7 44 24 04 89 4a 00 	movl   $0x4a89,0x4(%esp)
     8d5:	00 
     8d6:	89 04 24             	mov    %eax,(%esp)
     8d9:	e8 c4 38 00 00       	call   41a2 <printf>
    exit();
     8de:	e8 07 37 00 00       	call   3fea <exit>
  }

  if(unlink("dir0") < 0){
     8e3:	c7 04 24 6e 4a 00 00 	movl   $0x4a6e,(%esp)
     8ea:	e8 4b 37 00 00       	call   403a <unlink>
     8ef:	85 c0                	test   %eax,%eax
     8f1:	79 1a                	jns    90d <dirtest+0xc3>
    printf(stdout, "unlink dir0 failed\n");
     8f3:	a1 44 66 00 00       	mov    0x6644,%eax
     8f8:	c7 44 24 04 9a 4a 00 	movl   $0x4a9a,0x4(%esp)
     8ff:	00 
     900:	89 04 24             	mov    %eax,(%esp)
     903:	e8 9a 38 00 00       	call   41a2 <printf>
    exit();
     908:	e8 dd 36 00 00       	call   3fea <exit>
  }
  printf(stdout, "mkdir test ok\n");
     90d:	a1 44 66 00 00       	mov    0x6644,%eax
     912:	c7 44 24 04 ae 4a 00 	movl   $0x4aae,0x4(%esp)
     919:	00 
     91a:	89 04 24             	mov    %eax,(%esp)
     91d:	e8 80 38 00 00       	call   41a2 <printf>
}
     922:	c9                   	leave  
     923:	c3                   	ret    
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     92a:	a1 44 66 00 00       	mov    0x6644,%eax
     92f:	c7 44 24 04 bd 4a 00 	movl   $0x4abd,0x4(%esp)
     936:	00 
     937:	89 04 24             	mov    %eax,(%esp)
     93a:	e8 63 38 00 00       	call   41a2 <printf>
  if(exec("echo", echoargv) < 0){
     93f:	c7 44 24 04 30 66 00 	movl   $0x6630,0x4(%esp)
     946:	00 
     947:	c7 04 24 68 46 00 00 	movl   $0x4668,(%esp)
     94e:	e8 cf 36 00 00       	call   4022 <exec>
     953:	85 c0                	test   %eax,%eax
     955:	79 1a                	jns    971 <exectest+0x4d>
    printf(stdout, "exec echo failed\n");
     957:	a1 44 66 00 00       	mov    0x6644,%eax
     95c:	c7 44 24 04 c8 4a 00 	movl   $0x4ac8,0x4(%esp)
     963:	00 
     964:	89 04 24             	mov    %eax,(%esp)
     967:	e8 36 38 00 00       	call   41a2 <printf>
    exit();
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
     988:	c7 44 24 04 da 4a 00 	movl   $0x4ada,0x4(%esp)
     98f:	00 
     990:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     997:	e8 06 38 00 00       	call   41a2 <printf>
    exit();
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     9e3:	81 c2 20 8e 00 00    	add    $0x8e20,%edx
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     a02:	00 
     a03:	c7 44 24 04 20 8e 00 	movl   $0x8e20,0x4(%esp)
     a0a:	00 
     ...
     a1a:	c7 44 24 04 e9 4a 00 	movl   $0x4ae9,0x4(%esp)
     a21:	00 
     a22:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a29:	e8 74 37 00 00       	call   41a2 <printf>
        exit();
  ...
  if(pid == 0){
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a73:	05 20 8e 00 00       	add    $0x8e20,%eax
     ...
     a90:	c7 44 24 04 f7 4a 00 	movl   $0x4af7,0x4(%esp)
     a97:	00 
     a98:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     a9f:	e8 fe 36 00 00       	call   41a2 <printf>
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     ad9:	c7 44 24 04 20 8e 00 	movl   $0x8e20,0x4(%esp)
     ae0:	00 
    ...
    if(total != 5 * 1033){
     ...
     b06:	c7 44 24 04 05 4b 00 	movl   $0x4b05,0x4(%esp)
     b0d:	00 
     b0e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b15:	e8 88 36 00 00       	call   41a2 <printf>
      exit();
  ...
  printf(1, "pipe1 ok\n");
     b2f:	c7 44 24 04 2b 4b 00 	movl   $0x4b2b,0x4(%esp)
     b36:	00 
     b37:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b3e:	e8 5f 36 00 00       	call   41a2 <printf>
    ...
    printf(1, "fork() failed\n");
     b45:	c7 44 24 04 1c 4b 00 	movl   $0x4b1c,0x4(%esp)
     b4c:	00 
     b4d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b54:	e8 49 36 00 00       	call   41a2 <printf>
    exit();
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     b66:	c7 44 24 04 35 4b 00 	movl   $0x4b35,0x4(%esp)
     b6d:	00 
     b6e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     b75:	e8 28 36 00 00       	call   41a2 <printf>
  pid1 = fork();
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     bc8:	00 
     bc9:	c7 44 24 04 3f 4b 00 	movl   $0x4b3f,0x4(%esp)
     bd0:	00 
     ...
     bde:	c7 44 24 04 41 4b 00 	movl   $0x4b41,0x4(%esp)
     be5:	00 
     be6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     bed:	e8 b0 35 00 00       	call   41a2 <printf>
    close(pfds[1]);
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     ...
     c14:	00 
     c15:	c7 44 24 04 20 8e 00 	movl   $0x8e20,0x4(%esp)
     c1c:	00 
    ...
    printf(1, "preempt read error");
     c2a:	c7 44 24 04 55 4b 00 	movl   $0x4b55,0x4(%esp)
     c31:	00 
     c32:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c39:	e8 64 35 00 00       	call   41a2 <printf>
  ...
  printf(1, "kill... ");
     c4b:	c7 44 24 04 68 4b 00 	movl   $0x4b68,0x4(%esp)
     c52:	00 
     c53:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c5a:	e8 43 35 00 00       	call   41a2 <printf>
  kill(pid1);
  ...
  printf(1, "wait... ");
     c80:	c7 44 24 04 71 4b 00 	movl   $0x4b71,0x4(%esp)
     c87:	00 
     c88:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     c8f:	e8 0e 35 00 00       	call   41a2 <printf>
  wait();
  ...
  printf(1, "preempt ok\n");
     ca3:	c7 44 24 04 7a 4b 00 	movl   $0x4b7a,0x4(%esp)
     caa:	00 
     cab:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     cb2:	e8 eb 34 00 00       	call   41a2 <printf>
}
     cb7:	c9                   	leave  
     cb8:	c3                   	ret    
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     cd4:	79 16                	jns    cec <exitwait+0x33>
      printf(1, "fork failed\n");
     cd6:	c7 44 24 04 09 47 00 	movl   $0x4709,0x4(%esp)
     cdd:	00 
     cde:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     ce5:	e8 b8 34 00 00       	call   41a2 <printf>
      return;
    ...
    if(pid){
     ...
     cfc:	c7 44 24 04 86 4b 00 	movl   $0x4b86,0x4(%esp)
     d03:	00 
     d04:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d0b:	e8 92 34 00 00       	call   41a2 <printf>
        return;
...
exitwait(void)
{
  ...
  printf(1, "exitwait ok\n");
     d21:	c7 44 24 04 96 4b 00 	movl   $0x4b96,0x4(%esp)
     d28:	00 
     d29:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d30:	e8 6d 34 00 00       	call   41a2 <printf>
}
     d35:	c9                   	leave  
     d36:	c3                   	ret    
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     d3d:	c7 44 24 04 a3 4b 00 	movl   $0x4ba3,0x4(%esp)
     d44:	00 
     d45:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     d4c:	e8 51 34 00 00       	call   41a2 <printf>
  ppid = getpid();
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     d89:	e8 00 37 00 00       	call   448e <malloc>
    ...
    while(m1){
     ...
     da7:	e8 a9 35 00 00       	call   4355 <free>
      m1 = m2;
    ...
    free(m1);
     ...
     df7:	e8 59 35 00 00       	call   4355 <free>
    printf(1, "mem ok\n");
     dfc:	c7 44 24 04 c7 4b 00 	movl   $0x4bc7,0x4(%esp)
     e03:	00 
     e04:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e0b:	e8 92 33 00 00       	call   41a2 <printf>
    exit();
...
sharedfd(void)
{
  ...
  printf(1, "sharedfd test\n");
     e22:	c7 44 24 04 cf 4b 00 	movl   $0x4bcf,0x4(%esp)
     e29:	00 
     e2a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e31:	e8 6c 33 00 00       	call   41a2 <printf>

  unlink("sharedfd");
     e36:	c7 04 24 de 4b 00 00 	movl   $0x4bde,(%esp)
     e3d:	e8 f8 31 00 00       	call   403a <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     e42:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
     e49:	00 
     e4a:	c7 04 24 de 4b 00 00 	movl   $0x4bde,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     e5f:	c7 44 24 04 e8 4b 00 	movl   $0x4be8,0x4(%esp)
     e66:	00 
     e67:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     e6e:	e8 2f 33 00 00       	call   41a2 <printf>
    return;
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     ed1:	c7 44 24 04 14 4c 00 	movl   $0x4c14,0x4(%esp)
     ed8:	00 
     ed9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     ee0:	e8 bd 32 00 00       	call   41a2 <printf>
      break;
  ...
  fd = open("sharedfd", 0);
     ...
     f16:	00 
     f17:	c7 04 24 de 4b 00 00 	movl   $0x4bde,(%esp)
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     f2c:	c7 44 24 04 34 4c 00 	movl   $0x4c34,0x4(%esp)
     f33:	00 
     f34:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     f3b:	e8 62 32 00 00       	call   41a2 <printf>
    return;
  ...
  unlink("sharedfd");
     fbd:	c7 04 24 de 4b 00 00 	movl   $0x4bde,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     fdb:	c7 44 24 04 5f 4c 00 	movl   $0x4c5f,0x4(%esp)
     fe2:	00 
     fe3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
     fea:	e8 b3 31 00 00       	call   41a2 <printf>
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     ...
     fff:	c7 44 24 04 6c 4c 00 	movl   $0x4c6c,0x4(%esp)
    1006:	00 
    1007:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    100e:	e8 8f 31 00 00       	call   41a2 <printf>
    exit();
...
fourfiles(void)
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    1020:	c7 45 c8 81 4c 00 00 	movl   $0x4c81,-0x38(%ebp)
    1027:	c7 45 cc 84 4c 00 00 	movl   $0x4c84,-0x34(%ebp)
    102e:	c7 45 d0 87 4c 00 00 	movl   $0x4c87,-0x30(%ebp)
    1035:	c7 45 d4 8a 4c 00 00 	movl   $0x4c8a,-0x2c(%ebp)
  char *fname;

  printf(1, "fourfiles test\n");
    103c:	c7 44 24 04 8d 4c 00 	movl   $0x4c8d,0x4(%esp)
    1043:	00 
    1044:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    104b:	e8 52 31 00 00       	call   41a2 <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    107d:	79 19                	jns    1098 <fourfiles+0x7e>
      printf(1, "fork failed\n");
    107f:	c7 44 24 04 09 47 00 	movl   $0x4709,0x4(%esp)
    1086:	00 
    1087:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    108e:	e8 0f 31 00 00       	call   41a2 <printf>
      exit();
    ...
    10be:	c7 44 24 04 9d 4c 00 	movl   $0x4c9d,0x4(%esp)
    10c5:	00 
    10c6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    10cd:	e8 d0 30 00 00       	call   41a2 <printf>
        exit();
    ...
    10e9:	c7 04 24 20 8e 00 00 	movl   $0x8e20,(%esp)
    ...
    1105:	00 
    1106:	c7 44 24 04 20 8e 00 	movl   $0x8e20,0x4(%esp)
    110d:	00 
    ...
    112c:	c7 44 24 04 ac 4c 00 	movl   $0x4cac,0x4(%esp)
    1133:	00 
    1134:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    113b:	e8 62 30 00 00       	call   41a2 <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    11bb:	05 20 8e 00 00       	add    $0x8e20,%eax
    ...
    11ce:	74 19                	je     11e9 <fourfiles+0x1cf>
          printf(1, "wrong char\n");
    11d0:	c7 44 24 04 bd 4c 00 	movl   $0x4cbd,0x4(%esp)
    11d7:	00 
    11d8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    11df:	e8 be 2f 00 00       	call   41a2 <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    1202:	00 
    1203:	c7 44 24 04 20 8e 00 	movl   $0x8e20,0x4(%esp)
    120a:	00 
    ...
    123a:	c7 44 24 04 c9 4c 00 	movl   $0x4cc9,0x4(%esp)
    1241:	00 
    1242:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1249:	e8 54 2f 00 00       	call   41a2 <printf>
      exit();
  ...
  printf(1, "fourfiles ok\n");
    126c:	c7 44 24 04 da 4c 00 	movl   $0x4cda,0x4(%esp)
    1273:	00 
    1274:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    127b:	e8 22 2f 00 00       	call   41a2 <printf>
}
    1280:	c9                   	leave  
    1281:	c3                   	ret    
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
    1288:	c7 44 24 04 e8 4c 00 	movl   $0x4ce8,0x4(%esp)
    128f:	00 
    1290:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1297:	e8 06 2f 00 00       	call   41a2 <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    12b4:	79 19                	jns    12cf <createdelete+0x4d>
      printf(1, "fork failed\n");
    12b6:	c7 44 24 04 09 47 00 	movl   $0x4709,0x4(%esp)
    12bd:	00 
    12be:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    12c5:	e8 d8 2e 00 00       	call   41a2 <printf>
      exit();
    ...
    1315:	79 19                	jns    1330 <createdelete+0xae>
          printf(1, "create failed\n");
    1317:	c7 44 24 04 9d 4c 00 	movl   $0x4c9d,0x4(%esp)
    131e:	00 
    131f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1326:	e8 77 2e 00 00       	call   41a2 <printf>
          exit();
    ...
    136c:	c7 44 24 04 8c 47 00 	movl   $0x478c,0x4(%esp)
    1373:	00 
    1374:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    137b:	e8 22 2e 00 00       	call   41a2 <printf>
            exit();
  ...
  for(i = 0; i < N; i++){
    ...
    1429:	c7 44 24 04 fc 4c 00 	movl   $0x4cfc,0x4(%esp)
    1430:	00 
    1431:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1438:	e8 65 2d 00 00       	call   41a2 <printf>
        exit();
    ...
    145b:	c7 44 24 04 20 4d 00 	movl   $0x4d20,0x4(%esp)
    1462:	00 
    1463:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    146a:	e8 33 2d 00 00       	call   41a2 <printf>
        exit();
  ...
  printf(1, "createdelete ok\n");
    14e4:	c7 44 24 04 40 4d 00 	movl   $0x4d40,0x4(%esp)
    14eb:	00 
    14ec:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    14f3:	e8 aa 2c 00 00       	call   41a2 <printf>
}
    14f8:	c9                   	leave  
    14f9:	c3                   	ret    
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    1500:	c7 44 24 04 51 4d 00 	movl   $0x4d51,0x4(%esp)
    1507:	00 
    1508:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    150f:	e8 8e 2c 00 00       	call   41a2 <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    1514:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    151b:	00 
    151c:	c7 04 24 62 4d 00 00 	movl   $0x4d62,(%esp)
  ...
  if(fd < 0){
    ...
    1531:	c7 44 24 04 6d 4d 00 	movl   $0x4d6d,0x4(%esp)
    1538:	00 
    1539:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1540:	e8 5d 2c 00 00       	call   41a2 <printf>
    exit();
  ...
  write(fd, "hello", 5);
    ...
    1551:	00 
    1552:	c7 44 24 04 87 4d 00 	movl   $0x4d87,0x4(%esp)
    1559:	00 
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    1577:	00 
    1578:	c7 04 24 62 4d 00 00 	movl   $0x4d62,(%esp)
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1613:	00 
    1614:	c7 44 24 04 20 8e 00 	movl   $0x8e20,0x4(%esp)
    161b:	00 
    ...
    162c:	c7 44 24 04 c3 4d 00 	movl   $0x4dc3,0x4(%esp)
    1633:	00 
    1634:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    163b:	e8 62 2b 00 00       	call   41a2 <printf>
    exit();
    1640:	e8 a5 29 00 00       	call   3fea <exit>
  }
  if(buf[0] != 'h'){
    1645:	0f b6 05 20 8e 00 00 	movzbl 0x8e20,%eax
    164c:	3c 68                	cmp    $0x68,%al
    164e:	74 19                	je     1669 <unlinkread+0x16f>
    printf(1, "unlinkread wrong data\n");
    1650:	c7 44 24 04 da 4d 00 	movl   $0x4dda,0x4(%esp)
    1657:	00 
    1658:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    165f:	e8 3e 2b 00 00       	call   41a2 <printf>
    exit();
  ...
  if(write(fd, buf, 10) != 10){
    ...
    1670:	00 
    1671:	c7 44 24 04 20 8e 00 	movl   $0x8e20,0x4(%esp)
    1678:	00 
    ...
    1689:	c7 44 24 04 f1 4d 00 	movl   $0x4df1,0x4(%esp)
    1690:	00 
    1691:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1698:	e8 05 2b 00 00       	call   41a2 <printf>
    exit();
  ...
  unlink("unlinkread");
    16ad:	c7 04 24 62 4d 00 00 	movl   $0x4d62,(%esp)
    16b4:	e8 81 29 00 00       	call   403a <unlink>
  printf(1, "unlinkread ok\n");
    16b9:	c7 44 24 04 0a 4e 00 	movl   $0x4e0a,0x4(%esp)
    16c0:	00 
    16c1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    16c8:	e8 d5 2a 00 00       	call   41a2 <printf>
}
    16cd:	c9                   	leave  
    16ce:	c3                   	ret    
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    16d5:	c7 44 24 04 19 4e 00 	movl   $0x4e19,0x4(%esp)
    16dc:	00 
    16dd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    16e4:	e8 b9 2a 00 00       	call   41a2 <printf>

  unlink("lf1");
    16e9:	c7 04 24 23 4e 00 00 	movl   $0x4e23,(%esp)
    16f0:	e8 45 29 00 00       	call   403a <unlink>
  unlink("lf2");
    16f5:	c7 04 24 27 4e 00 00 	movl   $0x4e27,(%esp)
    16fc:	e8 39 29 00 00       	call   403a <unlink>

  fd = open("lf1", O_CREATE|O_RDWR);
    1701:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    1708:	00 
    1709:	c7 04 24 23 4e 00 00 	movl   $0x4e23,(%esp)
  ...
  if(fd < 0){
    ...
    171e:	c7 44 24 04 2b 4e 00 	movl   $0x4e2b,0x4(%esp)
    1725:	00 
    1726:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    172d:	e8 70 2a 00 00       	call   41a2 <printf>
    exit();
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    173e:	00 
    173f:	c7 44 24 04 87 4d 00 	movl   $0x4d87,0x4(%esp)
    1746:	00 
    ...
    1757:	c7 44 24 04 3e 4e 00 	movl   $0x4e3e,0x4(%esp)
    175e:	00 
    175f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1766:	e8 37 2a 00 00       	call   41a2 <printf>
    exit();
  ...
  fd = open("lf2", 0);
    ...
    17f0:	00 
    17f1:	c7 04 24 27 4e 00 00 	movl   $0x4e27,(%esp)
  ...
  if(fd < 0){
    ...
    1806:	c7 44 24 04 8d 4e 00 	movl   $0x4e8d,0x4(%esp)
    180d:	00 
    180e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1815:	e8 88 29 00 00       	call   41a2 <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1826:	00 
    1827:	c7 44 24 04 20 8e 00 	movl   $0x8e20,0x4(%esp)
    182e:	00 
    ...
    183f:	c7 44 24 04 9e 4e 00 	movl   $0x4e9e,0x4(%esp)
    1846:	00 
    1847:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    184e:	e8 4f 29 00 00       	call   41a2 <printf>
    exit();
  ...
  if(link("lf2", "lf2") >= 0){
    1863:	c7 44 24 04 27 4e 00 	movl   $0x4e27,0x4(%esp)
    186a:	00 
    186b:	c7 04 24 27 4e 00 00 	movl   $0x4e27,(%esp)
    1872:	e8 d3 27 00 00       	call   404a <link>
    1877:	85 c0                	test   %eax,%eax
    1879:	78 19                	js     1894 <linktest+0x1c5>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    187b:	c7 44 24 04 af 4e 00 	movl   $0x4eaf,0x4(%esp)
    1882:	00 
    1883:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    188a:	e8 13 29 00 00       	call   41a2 <printf>
    exit();
    188f:	e8 56 27 00 00       	call   3fea <exit>
  }

  unlink("lf2");
    1894:	c7 04 24 27 4e 00 00 	movl   $0x4e27,(%esp)
    189b:	e8 9a 27 00 00       	call   403a <unlink>
  if(link("lf2", "lf1") >= 0){
    18a0:	c7 44 24 04 23 4e 00 	movl   $0x4e23,0x4(%esp)
    18a7:	00 
    18a8:	c7 04 24 27 4e 00 00 	movl   $0x4e27,(%esp)
    18af:	e8 96 27 00 00       	call   404a <link>
    18b4:	85 c0                	test   %eax,%eax
    18b6:	78 19                	js     18d1 <linktest+0x202>
    printf(1, "link non-existant succeeded! oops\n");
    18b8:	c7 44 24 04 d0 4e 00 	movl   $0x4ed0,0x4(%esp)
    18bf:	00 
    18c0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18c7:	e8 d6 28 00 00       	call   41a2 <printf>
    exit();
    18cc:	e8 19 27 00 00       	call   3fea <exit>
  }

  if(link(".", "lf1") >= 0){
    18d1:	c7 44 24 04 23 4e 00 	movl   $0x4e23,0x4(%esp)
    18d8:	00 
    18d9:	c7 04 24 f3 4e 00 00 	movl   $0x4ef3,(%esp)
    18e0:	e8 65 27 00 00       	call   404a <link>
    18e5:	85 c0                	test   %eax,%eax
    18e7:	78 19                	js     1902 <linktest+0x233>
    printf(1, "link . lf1 succeeded! oops\n");
    18e9:	c7 44 24 04 f5 4e 00 	movl   $0x4ef5,0x4(%esp)
    18f0:	00 
    18f1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    18f8:	e8 a5 28 00 00       	call   41a2 <printf>
    exit();
    18fd:	e8 e8 26 00 00       	call   3fea <exit>
  }

  printf(1, "linktest ok\n");
    1902:	c7 44 24 04 11 4f 00 	movl   $0x4f11,0x4(%esp)
    1909:	00 
    190a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1911:	e8 8c 28 00 00       	call   41a2 <printf>
}
    1916:	c9                   	leave  
    1917:	c3                   	ret    
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    191e:	c7 44 24 04 1e 4f 00 	movl   $0x4f1e,0x4(%esp)
    1925:	00 
    1926:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    192d:	e8 70 28 00 00       	call   41a2 <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    1991:	c7 04 24 2e 4f 00 00 	movl   $0x4f2e,(%esp)
    ...
    19d4:	c7 04 24 2e 4f 00 00 	movl   $0x4f2e,(%esp)
    ...
    1a05:	c7 44 24 04 31 4f 00 	movl   $0x4f31,0x4(%esp)
    1a0c:	00 
    1a0d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1a14:	e8 89 27 00 00       	call   41a2 <printf>
        exit();
  ...
  fd = open(".", 0);
    ...
    1a69:	00 
    1a6a:	c7 04 24 f3 4e 00 00 	movl   $0x4ef3,(%esp)
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1acc:	c7 44 24 04 4d 4f 00 	movl   $0x4f4d,0x4(%esp)
    1ad3:	00 
    1ad4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1adb:	e8 c2 26 00 00       	call   41a2 <printf>
        exit();
    ...
    1afe:	c7 44 24 04 66 4f 00 	movl   $0x4f66,0x4(%esp)
    1b05:	00 
    1b06:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b0d:	e8 90 26 00 00       	call   41a2 <printf>
        exit();
  ...
  if(n != 40){
    ...
    1b59:	c7 44 24 04 84 4f 00 	movl   $0x4f84,0x4(%esp)
    1b60:	00 
    1b61:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1b68:	e8 35 26 00 00       	call   41a2 <printf>
    exit();
  ...
  for(i = 0; i < 40; i++){
    ...
    1b93:	79 19                	jns    1bae <concreate+0x296>
      printf(1, "fork failed\n");
    1b95:	c7 44 24 04 09 47 00 	movl   $0x4709,0x4(%esp)
    1b9c:	00 
    1b9d:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ba4:	e8 f9 25 00 00       	call   41a2 <printf>
      exit();
  ...
  printf(1, "concreate ok\n");
    1cb5:	c7 44 24 04 b5 4f 00 	movl   $0x4fb5,0x4(%esp)
    1cbc:	00 
    1cbd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1cc4:	e8 d9 24 00 00       	call   41a2 <printf>
}
    1cc9:	c9                   	leave  
    1cca:	c3                   	ret    
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    1cd1:	c7 44 24 04 c3 4f 00 	movl   $0x4fc3,0x4(%esp)
    1cd8:	00 
    1cd9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1ce0:	e8 bd 24 00 00       	call   41a2 <printf>

  unlink("x");
    1ce5:	c7 04 24 3f 4b 00 00 	movl   $0x4b3f,(%esp)
  ...
  if(pid < 0){
    ...
    printf(1, "fork failed\n");
    1cff:	c7 44 24 04 09 47 00 	movl   $0x4709,0x4(%esp)
    1d06:	00 
    1d07:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1d0e:	e8 8f 24 00 00       	call   41a2 <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    ...
    1d6d:	00 
    1d6e:	c7 04 24 3f 4b 00 00 	movl   $0x4b3f,(%esp)
    ...
    1d9f:	75 16                	jne    1db7 <linkunlink+0xec>
      link("cat", "x");
    1da1:	c7 44 24 04 3f 4b 00 	movl   $0x4b3f,0x4(%esp)
    1da8:	00 
    1da9:	c7 04 24 d4 4f 00 00 	movl   $0x4fd4,(%esp)
    1db0:	e8 95 22 00 00       	call   404a <link>
    1db5:	eb 0c                	jmp    1dc3 <linkunlink+0xf8>
    } else {
      unlink("x");
    1db7:	c7 04 24 3f 4b 00 00 	movl   $0x4b3f,(%esp)
  ...
  printf(1, "linkunlink ok\n");
    1de3:	c7 44 24 04 d8 4f 00 	movl   $0x4fd8,0x4(%esp)
    1dea:	00 
    1deb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1df2:	e8 ab 23 00 00       	call   41a2 <printf>
}
    1df7:	c9                   	leave  
    1df8:	c3                   	ret    
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
    1dff:	c7 44 24 04 e7 4f 00 	movl   $0x4fe7,0x4(%esp)
    1e06:	00 
    1e07:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e0e:	e8 8f 23 00 00       	call   41a2 <printf>
  unlink("bd");
    1e13:	c7 04 24 f4 4f 00 00 	movl   $0x4ff4,(%esp)
    1e1a:	e8 1b 22 00 00       	call   403a <unlink>

  fd = open("bd", O_CREATE);
    1e1f:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    1e26:	00 
    1e27:	c7 04 24 f4 4f 00 00 	movl   $0x4ff4,(%esp)
  ...
  if(fd < 0){
    ...
    1e3c:	c7 44 24 04 f7 4f 00 	movl   $0x4ff7,0x4(%esp)
    1e43:	00 
    1e44:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1e4b:	e8 52 23 00 00       	call   41a2 <printf>
    exit();
  ...
  unlink("bd");
    1ed6:	c7 04 24 f4 4f 00 00 	movl   $0x4ff4,(%esp)
  ...
  for(i = 0; i < 500; i++){
    ...
    1f2a:	c7 44 24 04 21 50 00 	movl   $0x5021,0x4(%esp)
    1f31:	00 
    1f32:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f39:	e8 64 22 00 00       	call   41a2 <printf>
      exit();
  ...
  printf(1, "bigdir ok\n");
    1f50:	c7 44 24 04 36 50 00 	movl   $0x5036,0x4(%esp)
    1f57:	00 
    1f58:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f5f:	e8 3e 22 00 00       	call   41a2 <printf>
}
    1f64:	c9                   	leave  
    1f65:	c3                   	ret    
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    1f6c:	c7 44 24 04 41 50 00 	movl   $0x5041,0x4(%esp)
    1f73:	00 
    1f74:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1f7b:	e8 22 22 00 00       	call   41a2 <printf>

  unlink("ff");
    1f80:	c7 04 24 4e 50 00 00 	movl   $0x504e,(%esp)
    1f87:	e8 ae 20 00 00       	call   403a <unlink>
  if(mkdir("dd") != 0){
    1f8c:	c7 04 24 51 50 00 00 	movl   $0x5051,(%esp)
    1f93:	e8 ba 20 00 00       	call   4052 <mkdir>
    1f98:	85 c0                	test   %eax,%eax
    1f9a:	74 19                	je     1fb5 <subdir+0x4f>
    printf(1, "subdir mkdir dd failed\n");
    1f9c:	c7 44 24 04 54 50 00 	movl   $0x5054,0x4(%esp)
    1fa3:	00 
    1fa4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1fab:	e8 f2 21 00 00       	call   41a2 <printf>
    exit();
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1fbc:	00 
    1fbd:	c7 04 24 6c 50 00 00 	movl   $0x506c,(%esp)
  ...
  if(fd < 0){
    ...
    1fd2:	c7 44 24 04 72 50 00 	movl   $0x5072,0x4(%esp)
    1fd9:	00 
    1fda:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1fe1:	e8 bc 21 00 00       	call   41a2 <printf>
    exit();
  ...
  write(fd, "ff", 2);
    ...
    1ff2:	00 
    1ff3:	c7 44 24 04 4e 50 00 	movl   $0x504e,0x4(%esp)
    1ffa:	00 
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    206a:	00 
    206b:	c7 04 24 d0 50 00 00 	movl   $0x50d0,(%esp)
  ...
  if(fd < 0){
    ...
    2080:	c7 44 24 04 d9 50 00 	movl   $0x50d9,0x4(%esp)
    2087:	00 
    2088:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    208f:	e8 0e 21 00 00       	call   41a2 <printf>
    exit();
  ...
  write(fd, "FF", 2);
    ...
    20a0:	00 
    20a1:	c7 44 24 04 f1 50 00 	movl   $0x50f1,0x4(%esp)
    20a8:	00 
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    20c6:	00 
    20c7:	c7 04 24 f4 50 00 00 	movl   $0x50f4,(%esp)
  ...
  if(fd < 0){
    ...
    20dc:	c7 44 24 04 00 51 00 	movl   $0x5100,0x4(%esp)
    20e3:	00 
    20e4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    20eb:	e8 b2 20 00 00       	call   41a2 <printf>
    exit();
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    20fc:	00 
    20fd:	c7 44 24 04 20 8e 00 	movl   $0x8e20,0x4(%esp)
    2104:	00 
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    2119:	0f b6 05 20 8e 00 00 	movzbl 0x8e20,%eax
    2120:	3c 66                	cmp    $0x66,%al
    2122:	74 19                	je     213d <subdir+0x1d7>
    printf(1, "dd/dd/../ff wrong content\n");
    2124:	c7 44 24 04 19 51 00 	movl   $0x5119,0x4(%esp)
    212b:	00 
    212c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2133:	e8 6a 20 00 00       	call   41a2 <printf>
    exit();
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    227e:	00 
    227f:	c7 04 24 34 51 00 00 	movl   $0x5134,(%esp)
  ...
  if(fd < 0){
    ...
    2294:	c7 44 24 04 fe 51 00 	movl   $0x51fe,0x4(%esp)
    229b:	00 
    229c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    22a3:	e8 fa 1e 00 00       	call   41a2 <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    22b4:	00 
    22b5:	c7 44 24 04 20 8e 00 	movl   $0x8e20,0x4(%esp)
    22bc:	00 
    ...
    22cd:	c7 44 24 04 16 52 00 	movl   $0x5216,0x4(%esp)
    22d4:	00 
    22d5:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    22dc:	e8 c1 1e 00 00       	call   41a2 <printf>
    exit();
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    26b2:	c7 44 24 04 90 54 00 	movl   $0x5490,0x4(%esp)
    26b9:	00 
    26ba:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    26c1:	e8 dc 1a 00 00       	call   41a2 <printf>

  unlink("bigwrite");
    26c6:	c7 04 24 9f 54 00 00 	movl   $0x549f,(%esp)
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    26e5:	00 
    26e6:	c7 04 24 9f 54 00 00 	movl   $0x549f,(%esp)
    ...
    26fb:	c7 44 24 04 a8 54 00 	movl   $0x54a8,0x4(%esp)
    2702:	00 
    2703:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    270a:	e8 93 1a 00 00       	call   41a2 <printf>
      exit();
    ...
    2724:	c7 44 24 04 20 8e 00 	movl   $0x8e20,0x4(%esp)
    272b:	00 
    ...
    2750:	c7 44 24 04 c0 54 00 	movl   $0x54c0,0x4(%esp)
    2757:	00 
    2758:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    275f:	e8 3e 1a 00 00       	call   41a2 <printf>
        exit();
    ...
    unlink("bigwrite");
    277e:	c7 04 24 9f 54 00 00 	movl   $0x549f,(%esp)
  ...
  printf(1, "bigwrite ok\n");
    279e:	c7 44 24 04 d2 54 00 	movl   $0x54d2,0x4(%esp)
    27a5:	00 
    27a6:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    27ad:	e8 f0 19 00 00       	call   41a2 <printf>
}
    27b2:	c9                   	leave  
    27b3:	c3                   	ret    
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
    27ba:	c7 44 24 04 df 54 00 	movl   $0x54df,0x4(%esp)
    27c1:	00 
    27c2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    27c9:	e8 d4 19 00 00       	call   41a2 <printf>

  unlink("bigfile");
    27ce:	c7 04 24 ed 54 00 00 	movl   $0x54ed,(%esp)
    27d5:	e8 60 18 00 00       	call   403a <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    27da:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    27e1:	00 
    27e2:	c7 04 24 ed 54 00 00 	movl   $0x54ed,(%esp)
  ...
  if(fd < 0){
    ...
    27f7:	c7 44 24 04 f5 54 00 	movl   $0x54f5,0x4(%esp)
    27fe:	00 
    27ff:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2806:	e8 97 19 00 00       	call   41a2 <printf>
    exit();
  ...
  for(i = 0; i < 20; i++){
    ...
    2828:	c7 04 24 20 8e 00 00 	movl   $0x8e20,(%esp)
    282f:	e8 09 16 00 00       	call   3e3d <memset>
    if(write(fd, buf, 600) != 600){
    2834:	c7 44 24 08 58 02 00 	movl   $0x258,0x8(%esp)
    283b:	00 
    283c:	c7 44 24 04 20 8e 00 	movl   $0x8e20,0x4(%esp)
    2843:	00 
    ...
    2856:	c7 44 24 04 0b 55 00 	movl   $0x550b,0x4(%esp)
    285d:	00 
    285e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2865:	e8 38 19 00 00       	call   41a2 <printf>
      exit();
  ...
  fd = open("bigfile", 0);
    ...
    288b:	00 
    288c:	c7 04 24 ed 54 00 00 	movl   $0x54ed,(%esp)
  ...
  if(fd < 0){
    ...
    28a1:	c7 44 24 04 21 55 00 	movl   $0x5521,0x4(%esp)
    28a8:	00 
    28a9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    28b0:	e8 ed 18 00 00       	call   41a2 <printf>
    exit();
  ...
  for(i = 0; ; i++){
    ...
    28cf:	00 
    28d0:	c7 44 24 04 20 8e 00 	movl   $0x8e20,0x4(%esp)
    28d7:	00 
    ...
    28ec:	c7 44 24 04 36 55 00 	movl   $0x5536,0x4(%esp)
    28f3:	00 
    28f4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    28fb:	e8 a2 18 00 00       	call   41a2 <printf>
      exit();
  ...
  if(total != 20*600){
    ...
    292f:	c7 44 24 04 4b 55 00 	movl   $0x554b,0x4(%esp)
    2936:	00 
    2937:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    293e:	e8 5f 18 00 00       	call   41a2 <printf>
      exit();
    2943:	e8 a2 16 00 00       	call   3fea <exit>
    }
    if(buf[0] != i/2 || buf[299] != i/2){
    2948:	0f b6 05 20 8e 00 00 	movzbl 0x8e20,%eax
    ...
    2962:	0f b6 05 4b 8f 00 00 	movzbl 0x8f4b,%eax
    ...
    297a:	74 19                	je     2995 <bigfile+0x1e1>
      printf(1, "read bigfile wrong data\n");
    297c:	c7 44 24 04 5f 55 00 	movl   $0x555f,0x4(%esp)
    2983:	00 
    2984:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    298b:	e8 12 18 00 00       	call   41a2 <printf>
      exit();
  ...
  if(total != 20*600){
    ...
    29a4:	c7 44 24 04 78 55 00 	movl   $0x5578,0x4(%esp)
    29ab:	00 
    29ac:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    29b3:	e8 ea 17 00 00       	call   41a2 <printf>
    exit();
    29b8:	e8 2d 16 00 00       	call   3fea <exit>
  }
  unlink("bigfile");
    29bd:	c7 04 24 ed 54 00 00 	movl   $0x54ed,(%esp)
    29c4:	e8 71 16 00 00       	call   403a <unlink>

  printf(1, "bigfile test ok\n");
    29c9:	c7 44 24 04 92 55 00 	movl   $0x5592,0x4(%esp)
    29d0:	00 
    29d1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    29d8:	e8 c5 17 00 00       	call   41a2 <printf>
}
    29dd:	c9                   	leave  
    29de:	c3                   	ret    
...
fourteen(void)
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2a52:	00 
    2a53:	c7 04 24 30 56 00 00 	movl   $0x5630,(%esp)
  ...
  if(fd < 0){
    ...
    2a68:	c7 44 24 04 60 56 00 	movl   $0x5660,0x4(%esp)
    2a6f:	00 
    2a70:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2a77:	e8 26 17 00 00       	call   41a2 <printf>
    exit();
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2a93:	00 
    2a94:	c7 04 24 a0 56 00 00 	movl   $0x56a0,(%esp)
  ...
  if(fd < 0){
    ...
    2aa9:	c7 44 24 04 d0 56 00 	movl   $0x56d0,0x4(%esp)
    2ab0:	00 
    2ab1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ab8:	e8 e5 16 00 00       	call   41a2 <printf>
    exit();
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    2cb3:	c7 44 24 04 67 58 00 	movl   $0x5867,0x4(%esp)
    2cba:	00 
    2cbb:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2cc2:	e8 db 14 00 00       	call   41a2 <printf>

  fd = open("dirfile", O_CREATE);
    2cc7:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    2cce:	00 
    2ccf:	c7 04 24 74 58 00 00 	movl   $0x5874,(%esp)
  ...
  if(fd < 0){
    ...
    2ce4:	c7 44 24 04 7c 58 00 	movl   $0x587c,0x4(%esp)
    2ceb:	00 
    2cec:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2cf3:	e8 aa 14 00 00       	call   41a2 <printf>
    exit();
  ...
  fd = open("dirfile/xx", 0);
    ...
    2d38:	00 
    2d39:	c7 04 24 ad 58 00 00 	movl   $0x58ad,(%esp)
  ...
  if(fd >= 0){
    ...
    2d4e:	c7 44 24 04 b8 58 00 	movl   $0x58b8,0x4(%esp)
    2d55:	00 
    2d56:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2d5d:	e8 40 14 00 00       	call   41a2 <printf>
    exit();
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    2d6e:	00 
    2d6f:	c7 04 24 ad 58 00 00 	movl   $0x58ad,(%esp)
  ...
  fd = open(".", O_RDWR);
    ...
    2e50:	00 
    2e51:	c7 04 24 f3 4e 00 00 	movl   $0x4ef3,(%esp)
  ...
  if(fd >= 0){
    ...
    2e66:	c7 44 24 04 50 59 00 	movl   $0x5950,0x4(%esp)
    2e6d:	00 
    2e6e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e75:	e8 28 13 00 00       	call   41a2 <printf>
    exit();
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2eb5:	c7 44 24 04 6f 59 00 	movl   $0x596f,0x4(%esp)
    2ebc:	00 
    2ebd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ec4:	e8 d9 12 00 00       	call   41a2 <printf>
    exit();
  ...
  printf(1, "dir vs file OK\n");
    2ed9:	c7 44 24 04 83 59 00 	movl   $0x5983,0x4(%esp)
    2ee0:	00 
    2ee1:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2ee8:	e8 b5 12 00 00       	call   41a2 <printf>
}
    2eed:	c9                   	leave  
    2eee:	c3                   	ret    
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    2ef5:	c7 44 24 04 93 59 00 	movl   $0x5993,0x4(%esp)
    2efc:	00 
    2efd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2f04:	e8 99 12 00 00       	call   41a2 <printf>
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2fb6:	00 
    2fb7:	c7 04 24 d3 59 00 00 	movl   $0x59d3,(%esp)
    ...
    unlink("xx");
    2fd7:	c7 04 24 d3 59 00 00 	movl   $0x59d3,(%esp)
  ...
  chdir("/");
    2ff1:	c7 04 24 da 46 00 00 	movl   $0x46da,(%esp)
    2ff8:	e8 5d 10 00 00       	call   405a <chdir>
  printf(1, "empty file name OK\n");
    2ffd:	c7 44 24 04 d6 59 00 	movl   $0x59d6,0x4(%esp)
    3004:	00 
    3005:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    300c:	e8 91 11 00 00       	call   41a2 <printf>
}
    3011:	c9                   	leave  
    3012:	c3                   	ret    
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    3019:	c7 44 24 04 ea 59 00 	movl   $0x59ea,0x4(%esp)
    3020:	00 
    3021:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3028:	e8 75 11 00 00       	call   41a2 <printf>
    ...
    304c:	e8 99 0f 00 00       	call   3fea <exit>
{
  ...
  if(n == 1000){
    ...
    3067:	c7 44 24 04 f8 59 00 	movl   $0x59f8,0x4(%esp)
    306e:	00 
    306f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3076:	e8 27 11 00 00       	call   41a2 <printf>
    exit();
  ...
  for(; n > 0; n--){
    ...
    308b:	c7 44 24 04 1a 5a 00 	movl   $0x5a1a,0x4(%esp)
    3092:	00 
    3093:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    309a:	e8 03 11 00 00       	call   41a2 <printf>
      exit();
  ...
  if(wait() != -1){
    ...
    30b8:	c7 44 24 04 2e 5a 00 	movl   $0x5a2e,0x4(%esp)
    30bf:	00 
    30c0:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    30c7:	e8 d6 10 00 00       	call   41a2 <printf>
    exit();
    30cc:	e8 19 0f 00 00       	call   3fea <exit>
  }

  printf(1, "fork test OK\n");
    30d1:	c7 44 24 04 41 5a 00 	movl   $0x5a41,0x4(%esp)
    30d8:	00 
    30d9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    30e0:	e8 bd 10 00 00       	call   41a2 <printf>
}
    30e5:	c9                   	leave  
    30e6:	c3                   	ret    
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    30f1:	a1 44 66 00 00       	mov    0x6644,%eax
    30f6:	c7 44 24 04 4f 5a 00 	movl   $0x5a4f,0x4(%esp)
    30fd:	00 
    30fe:	89 04 24             	mov    %eax,(%esp)
    3101:	e8 9c 10 00 00       	call   41a2 <printf>
  oldbrk = sbrk(0);
  ...
  for(i = 0; i < 5000; i++){
    ...
    3144:	a1 44 66 00 00       	mov    0x6644,%eax
    ...
    315e:	c7 44 24 04 5a 5a 00 	movl   $0x5a5a,0x4(%esp)
    3165:	00 
    3166:	89 04 24             	mov    %eax,(%esp)
    3169:	e8 34 10 00 00       	call   41a2 <printf>
      exit();
  ...
  if(pid < 0){
    ...
    319d:	a1 44 66 00 00       	mov    0x6644,%eax
    31a2:	c7 44 24 04 75 5a 00 	movl   $0x5a75,0x4(%esp)
    31a9:	00 
    31aa:	89 04 24             	mov    %eax,(%esp)
    31ad:	e8 f0 0f 00 00       	call   41a2 <printf>
    exit();
  ...
  if(c != a + 1){
    ...
    31e0:	a1 44 66 00 00       	mov    0x6644,%eax
    31e5:	c7 44 24 04 8c 5a 00 	movl   $0x5a8c,0x4(%esp)
    31ec:	00 
    31ed:	89 04 24             	mov    %eax,(%esp)
    31f0:	e8 ad 0f 00 00       	call   41a2 <printf>
    exit();
...
#define BIG (100*1024*1024)
  ...
  if (p != a) {
    ...
    323e:	a1 44 66 00 00       	mov    0x6644,%eax
    3243:	c7 44 24 04 a8 5a 00 	movl   $0x5aa8,0x4(%esp)
    324a:	00 
    324b:	89 04 24             	mov    %eax,(%esp)
    324e:	e8 4f 0f 00 00       	call   41a2 <printf>
    exit();
  ...
  *lastaddr = 99;
  ...
  if(c == (char*)0xffffffff){
    ...
    3289:	a1 44 66 00 00       	mov    0x6644,%eax
    328e:	c7 44 24 04 e6 5a 00 	movl   $0x5ae6,0x4(%esp)
    3295:	00 
    3296:	89 04 24             	mov    %eax,(%esp)
    3299:	e8 04 0f 00 00       	call   41a2 <printf>
    exit();
  ...
  if(c != a - 4096){
    ...
    32bf:	a1 44 66 00 00       	mov    0x6644,%eax
    ...
    32d2:	c7 44 24 04 04 5b 00 	movl   $0x5b04,0x4(%esp)
    32d9:	00 
    32da:	89 04 24             	mov    %eax,(%esp)
    32dd:	e8 c0 0e 00 00       	call   41a2 <printf>
    exit();
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    3326:	a1 44 66 00 00       	mov    0x6644,%eax
    ...
    3339:	c7 44 24 04 3c 5b 00 	movl   $0x5b3c,0x4(%esp)
    3340:	00 
    3341:	89 04 24             	mov    %eax,(%esp)
    3344:	e8 59 0e 00 00       	call   41a2 <printf>
    exit();
  ...
  if(*lastaddr == 99){
    ...
    3358:	a1 44 66 00 00       	mov    0x6644,%eax
    335d:	c7 44 24 04 64 5b 00 	movl   $0x5b64,0x4(%esp)
    3364:	00 
    3365:	89 04 24             	mov    %eax,(%esp)
    3368:	e8 35 0e 00 00       	call   41a2 <printf>
    exit();
  ...
  if(c != a){
    ...
    33a7:	a1 44 66 00 00       	mov    0x6644,%eax
    ...
    33ba:	c7 44 24 04 94 5b 00 	movl   $0x5b94,0x4(%esp)
    33c1:	00 
    33c2:	89 04 24             	mov    %eax,(%esp)
    33c5:	e8 d8 0d 00 00       	call   41a2 <printf>
    exit();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    33ec:	79 1a                	jns    3408 <sbrktest+0x321>
      printf(stdout, "fork failed\n");
    33ee:	a1 44 66 00 00       	mov    0x6644,%eax
    33f3:	c7 44 24 04 09 47 00 	movl   $0x4709,0x4(%esp)
    33fa:	00 
    33fb:	89 04 24             	mov    %eax,(%esp)
    33fe:	e8 9f 0d 00 00       	call   41a2 <printf>
      exit();
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
    346f:	c7 44 24 04 da 4a 00 	movl   $0x4ada,0x4(%esp)
    3476:	00 
    3477:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    347e:	e8 1f 0d 00 00       	call   41a2 <printf>
    exit();
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    34d2:	00 
    34d3:	c7 44 24 04 3f 4b 00 	movl   $0x4b3f,0x4(%esp)
    34da:	00 
  ...
  if(c == (char*)0xffffffff){
    ...
    3573:	a1 44 66 00 00       	mov    0x6644,%eax
    3578:	c7 44 24 04 ce 5b 00 	movl   $0x5bce,0x4(%esp)
    357f:	00 
    3580:	89 04 24             	mov    %eax,(%esp)
    3583:	e8 1a 0c 00 00       	call   41a2 <printf>
    exit();
  ...
  printf(stdout, "sbrk test OK\n");
    35b9:	a1 44 66 00 00       	mov    0x6644,%eax
    35be:	c7 44 24 04 e9 5b 00 	movl   $0x5be9,0x4(%esp)
    35c5:	00 
    35c6:	89 04 24             	mov    %eax,(%esp)
    35c9:	e8 d4 0b 00 00       	call   41a2 <printf>
}
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    35ff:	a1 44 66 00 00       	mov    0x6644,%eax
    3604:	c7 44 24 04 f7 5b 00 	movl   $0x5bf7,0x4(%esp)
    360b:	00 
    360c:	89 04 24             	mov    %eax,(%esp)
    360f:	e8 8e 0b 00 00       	call   41a2 <printf>
  hi = 1100*1024;
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    3671:	c7 04 24 06 5c 00 00 	movl   $0x5c06,(%esp)
    3678:	e8 cd 09 00 00       	call   404a <link>
    367d:	83 f8 ff             	cmp    $0xffffffff,%eax
    3680:	74 1a                	je     369c <validatetest+0xa3>
      printf(stdout, "link should not succeed\n");
    3682:	a1 44 66 00 00       	mov    0x6644,%eax
    3687:	c7 44 24 04 11 5c 00 	movl   $0x5c11,0x4(%esp)
    368e:	00 
    368f:	89 04 24             	mov    %eax,(%esp)
    3692:	e8 0b 0b 00 00       	call   41a2 <printf>
      exit();
  ...
  printf(stdout, "validate ok\n");
    36af:	a1 44 66 00 00       	mov    0x6644,%eax
    36b4:	c7 44 24 04 2a 5c 00 	movl   $0x5c2a,0x4(%esp)
    36bb:	00 
    36bc:	89 04 24             	mov    %eax,(%esp)
    36bf:	e8 de 0a 00 00       	call   41a2 <printf>
}
    36c4:	c9                   	leave  
    36c5:	c3                   	ret    
...
bsstest(void)
{
  ...
  printf(stdout, "bss test ok\n");
    3721:	a1 44 66 00 00       	mov    0x6644,%eax
    3726:	c7 44 24 04 52 5c 00 	movl   $0x5c52,0x4(%esp)
    372d:	00 
    372e:	89 04 24             	mov    %eax,(%esp)
    3731:	e8 6c 0a 00 00       	call   41a2 <printf>
}
    3736:	c9                   	leave  
    3737:	c3                   	ret    
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    373e:	c7 04 24 5f 5c 00 00 	movl   $0x5c5f,(%esp)
  ...
  if(pid == 0){
    ...
    3768:	c7 04 85 60 66 00 00 	movl   $0x5c6c,0x6660(,%eax,4)
    376f:	6c 5c 00 00 
  unlink("bigarg-ok");
  pid = fork();
  if(pid == 0){
    ...
    377b:	7e e8                	jle    3765 <bigargtest+0x2d>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    args[MAXARG-1] = 0;
    377d:	c7 05 dc 66 00 00 00 	movl   $0x0,0x66dc
    3784:	00 00 00 
    printf(stdout, "bigarg test\n");
    3787:	a1 44 66 00 00       	mov    0x6644,%eax
    378c:	c7 44 24 04 49 5d 00 	movl   $0x5d49,0x4(%esp)
    3793:	00 
    3794:	89 04 24             	mov    %eax,(%esp)
    3797:	e8 06 0a 00 00       	call   41a2 <printf>
    exec("echo", args);
    379c:	c7 44 24 04 60 66 00 	movl   $0x6660,0x4(%esp)
    37a3:	00 
    37a4:	c7 04 24 68 46 00 00 	movl   $0x4668,(%esp)
    37ab:	e8 72 08 00 00       	call   4022 <exec>
    printf(stdout, "bigarg test ok\n");
    37b0:	a1 44 66 00 00       	mov    0x6644,%eax
    37b5:	c7 44 24 04 56 5d 00 	movl   $0x5d56,0x4(%esp)
    37bc:	00 
    37bd:	89 04 24             	mov    %eax,(%esp)
    37c0:	e8 dd 09 00 00       	call   41a2 <printf>
    fd = open("bigarg-ok", O_CREATE);
    37c5:	c7 44 24 04 00 02 00 	movl   $0x200,0x4(%esp)
    37cc:	00 
    37cd:	c7 04 24 5f 5c 00 00 	movl   $0x5c5f,(%esp)
    ...
    37f2:	a1 44 66 00 00       	mov    0x6644,%eax
    37f7:	c7 44 24 04 66 5d 00 	movl   $0x5d66,0x4(%esp)
    37fe:	00 
    37ff:	89 04 24             	mov    %eax,(%esp)
    3802:	e8 9b 09 00 00       	call   41a2 <printf>
    exit();
  ...
  fd = open("bigarg-ok", 0);
    ...
    3818:	00 
    3819:	c7 04 24 5f 5c 00 00 	movl   $0x5c5f,(%esp)
  ...
  if(fd < 0){
    ...
    382e:	a1 44 66 00 00       	mov    0x6644,%eax
    3833:	c7 44 24 04 7f 5d 00 	movl   $0x5d7f,0x4(%esp)
    383a:	00 
    383b:	89 04 24             	mov    %eax,(%esp)
    383e:	e8 5f 09 00 00       	call   41a2 <printf>
    exit();
  ...
  unlink("bigarg-ok");
    3853:	c7 04 24 5f 5c 00 00 	movl   $0x5c5f,(%esp)
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    386f:	c7 44 24 04 94 5d 00 	movl   $0x5d94,0x4(%esp)
    3876:	00 
    3877:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    387e:	e8 1f 09 00 00       	call   41a2 <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3959:	c7 44 24 04 a1 5d 00 	movl   $0x5da1,0x4(%esp)
    3960:	00 
    3961:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3968:	e8 35 08 00 00       	call   41a2 <printf>
    ...
    3990:	c7 44 24 04 ad 5d 00 	movl   $0x5dad,0x4(%esp)
    3997:	00 
    3998:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    399f:	e8 fe 07 00 00       	call   41a2 <printf>
      break;
    ...
    39b4:	00 
    39b5:	c7 44 24 04 20 8e 00 	movl   $0x8e20,0x4(%esp)
    39bc:	00 
    ...
    39dc:	c7 44 24 04 bd 5d 00 	movl   $0x5dbd,0x4(%esp)
    39e3:	00 
    39e4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    39eb:	e8 b2 07 00 00       	call   41a2 <printf>
    close(fd);
  ...
  printf(1, "fsfull test finished\n");
    3b00:	c7 44 24 04 cd 5d 00 	movl   $0x5dcd,0x4(%esp)
    3b07:	00 
    3b08:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3b0f:	e8 8e 06 00 00       	call   41a2 <printf>
}
...
uio()
{
  ...
  printf(1, "uio test\n");
    3b2a:	c7 44 24 04 e3 5d 00 	movl   $0x5de3,0x4(%esp)
    3b31:	00 
    3b32:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3b39:	e8 64 06 00 00       	call   41a2 <printf>
  pid = fork();
  ...
  if(pid == 0){
    ...
    3b6f:	c7 44 24 04 f0 5d 00 	movl   $0x5df0,0x4(%esp)
    3b76:	00 
    3b77:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3b7e:	e8 1f 06 00 00       	call   41a2 <printf>
    exit();
    ...
    printf (1, "fork failed\n");
    3b8e:	c7 44 24 04 09 47 00 	movl   $0x4709,0x4(%esp)
    3b95:	00 
    3b96:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3b9d:	e8 00 06 00 00       	call   41a2 <printf>
    exit();
  ...
  printf(1, "uio test done\n");
    3bac:	c7 44 24 04 11 5e 00 	movl   $0x5e11,0x4(%esp)
    3bb3:	00 
    3bb4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3bbb:	e8 e2 05 00 00       	call   41a2 <printf>
}
    3bc0:	c9                   	leave  
    3bc1:	c3                   	ret    
...
void argptest()
{
  ...
  fd = open("init", O_RDONLY);
    ...
    3bcf:	00 
    3bd0:	c7 04 24 20 5e 00 00 	movl   $0x5e20,(%esp)
  ...
  if (fd < 0) {
    ...
    3be5:	c7 44 24 04 25 5e 00 	movl   $0x5e25,0x4(%esp)
    3bec:	00 
    3bed:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    3bf4:	e8 a9 05 00 00       	call   41a2 <printf>
    exit();
  ...
  printf(1, "arg test passed\n");
    3c2f:	c7 44 24 04 32 5e 00 	movl   $0x5e32,0x4(%esp)
    3c36:	00 
    3c37:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3c3e:	e8 5f 05 00 00       	call   41a2 <printf>
}
    3c43:	c9                   	leave  
    3c44:	c3                   	ret    
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    3c48:	a1 48 66 00 00       	mov    0x6648,%eax
    3c4d:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    3c53:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    3c58:	a3 48 66 00 00       	mov    %eax,0x6648
  return randstate;
    3c5d:	a1 48 66 00 00       	mov    0x6648,%eax
}
    3c62:	5d                   	pop    %ebp
    3c63:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    3cb9:	00 
    3cba:	c7 04 24 57 5e 00 00 	movl   $0x5e57,(%esp)
...
putc(int fd, char c)
{
    ...
    40c5:	83 ec 18             	sub    $0x18,%esp
    40c8:	8b 45 0c             	mov    0xc(%ebp),%eax
    40cb:	88 45 f4             	mov    %al,-0xc(%ebp)
  write(fd, &c, 1);
    40ce:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    40d5:	00 
    40d6:	8d 45 f4             	lea    -0xc(%ebp),%eax
    40d9:	89 44 24 04          	mov    %eax,0x4(%esp)
    40dd:	8b 45 08             	mov    0x8(%ebp),%eax
    40e0:	89 04 24             	mov    %eax,(%esp)
    40e3:	e8 22 ff ff ff       	call   400a <write>
}
    40e8:	c9                   	leave  
    40e9:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
    40f2:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
    40f9:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
    40fd:	74 17                	je     4116 <printint+0x2c>
    40ff:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
    4103:	79 11                	jns    4116 <printint+0x2c>
    neg = 1;
    4105:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
    410c:	8b 45 0c             	mov    0xc(%ebp),%eax
    410f:	f7 d8                	neg    %eax
    4111:	89 45 ec             	mov    %eax,-0x14(%ebp)
    4114:	eb 06                	jmp    411c <printint+0x32>
  } else {
    x = xx;
  ...
  i = 0;
    411c:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  do{
    buf[i++] = digits[x % base];
    4123:	8b 4d f4             	mov    -0xc(%ebp),%ecx
    4126:	8d 41 01             	lea    0x1(%ecx),%eax
    4129:	89 45 f4             	mov    %eax,-0xc(%ebp)
    412c:	8b 5d 10             	mov    0x10(%ebp),%ebx
    412f:	8b 45 ec             	mov    -0x14(%ebp),%eax
    4132:	ba 00 00 00 00       	mov    $0x0,%edx
    4137:	f7 f3                	div    %ebx
    4139:	89 d0                	mov    %edx,%eax
    413b:	0f b6 80 4c 66 00 00 	movzbl 0x664c(%eax),%eax
    4142:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
  }while((x /= base) != 0);
    4146:	8b 75 10             	mov    0x10(%ebp),%esi
    4149:	8b 45 ec             	mov    -0x14(%ebp),%eax
    414c:	ba 00 00 00 00       	mov    $0x0,%edx
    4151:	f7 f6                	div    %esi
    4153:	89 45 ec             	mov    %eax,-0x14(%ebp)
    4156:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    415a:	75 c7                	jne    4123 <printint+0x39>
  if(neg)
    415c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    4160:	74 10                	je     4172 <printint+0x88>
    buf[i++] = '-';
    4162:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4165:	8d 50 01             	lea    0x1(%eax),%edx
    4168:	89 55 f4             	mov    %edx,-0xc(%ebp)
    416b:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
    4170:	eb 1f                	jmp    4191 <printint+0xa7>
    4172:	eb 1d                	jmp    4191 <printint+0xa7>
    putc(fd, buf[i]);
    4174:	8d 55 dc             	lea    -0x24(%ebp),%edx
    4177:	8b 45 f4             	mov    -0xc(%ebp),%eax
    417a:	01 d0                	add    %edx,%eax
    ...
    418c:	e8 31 ff ff ff       	call   40c2 <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
    4191:	83 6d f4 01          	subl   $0x1,-0xc(%ebp)
    4195:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    4199:	79 d9                	jns    4174 <printint+0x8a>
    putc(fd, buf[i]);
}
    419b:	83 c4 30             	add    $0x30,%esp
    419e:	5b                   	pop    %ebx
    419f:	5e                   	pop    %esi
    41a0:	5d                   	pop    %ebp
    41a1:	c3                   	ret    
...
printf(int fd, char *fmt, ...)
{
    ...
    41a5:	83 ec 38             	sub    $0x38,%esp
  char *s;
  int c, i, state;
  uint *ap;

  state = 0;
    41a8:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
    41af:	8d 45 0c             	lea    0xc(%ebp),%eax
    41b2:	83 c0 04             	add    $0x4,%eax
    41b5:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
    41b8:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    41bf:	e9 7c 01 00 00       	jmp    4340 <printf+0x19e>
    c = fmt[i] & 0xff;
    41c4:	8b 55 0c             	mov    0xc(%ebp),%edx
    41c7:	8b 45 f0             	mov    -0x10(%ebp),%eax
    41ca:	01 d0                	add    %edx,%eax
    41cc:	0f b6 00             	movzbl (%eax),%eax
    41cf:	0f be c0             	movsbl %al,%eax
    41d2:	25 ff 00 00 00       	and    $0xff,%eax
    41d7:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
    41da:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    41de:	75 2c                	jne    420c <printf+0x6a>
      if(c == '%'){
    41e0:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    41e4:	75 0c                	jne    41f2 <printf+0x50>
        state = '%';
    41e6:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
    41ed:	e9 4a 01 00 00       	jmp    433c <printf+0x19a>
      } else {
        putc(fd, c);
    41f2:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    41f5:	0f be c0             	movsbl %al,%eax
    41f8:	89 44 24 04          	mov    %eax,0x4(%esp)
    41fc:	8b 45 08             	mov    0x8(%ebp),%eax
    41ff:	89 04 24             	mov    %eax,(%esp)
    4202:	e8 bb fe ff ff       	call   40c2 <putc>
    4207:	e9 30 01 00 00       	jmp    433c <printf+0x19a>
      }
    } else if(state == '%'){
    420c:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
    4210:	0f 85 26 01 00 00    	jne    433c <printf+0x19a>
      if(c == 'd'){
    4216:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
    421a:	75 2d                	jne    4249 <printf+0xa7>
        printint(fd, *ap, 10, 1);
    421c:	8b 45 e8             	mov    -0x18(%ebp),%eax
    421f:	8b 00                	mov    (%eax),%eax
    4221:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
    4228:	00 
    4229:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
    4230:	00 
    4231:	89 44 24 04          	mov    %eax,0x4(%esp)
    4235:	8b 45 08             	mov    0x8(%ebp),%eax
    4238:	89 04 24             	mov    %eax,(%esp)
    423b:	e8 aa fe ff ff       	call   40ea <printint>
        ap++;
    4240:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    4244:	e9 ec 00 00 00       	jmp    4335 <printf+0x193>
      } else if(c == 'x' || c == 'p'){
    4249:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
    424d:	74 06                	je     4255 <printf+0xb3>
    424f:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
    4253:	75 2d                	jne    4282 <printf+0xe0>
        printint(fd, *ap, 16, 0);
    4255:	8b 45 e8             	mov    -0x18(%ebp),%eax
    4258:	8b 00                	mov    (%eax),%eax
    425a:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
    4261:	00 
    4262:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
    4269:	00 
    426a:	89 44 24 04          	mov    %eax,0x4(%esp)
    426e:	8b 45 08             	mov    0x8(%ebp),%eax
    4271:	89 04 24             	mov    %eax,(%esp)
    4274:	e8 71 fe ff ff       	call   40ea <printint>
        ap++;
    4279:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    427d:	e9 b3 00 00 00       	jmp    4335 <printf+0x193>
      } else if(c == 's'){
    4282:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
    4286:	75 45                	jne    42cd <printf+0x12b>
        s = (char*)*ap;
    4288:	8b 45 e8             	mov    -0x18(%ebp),%eax
    428b:	8b 00                	mov    (%eax),%eax
    428d:	89 45 f4             	mov    %eax,-0xc(%ebp)
        ap++;
    4290:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
        if(s == 0)
    4294:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    4298:	75 09                	jne    42a3 <printf+0x101>
          s = "(null)";
    429a:	c7 45 f4 92 5e 00 00 	movl   $0x5e92,-0xc(%ebp)
        while(*s != 0){
    42a1:	eb 1e                	jmp    42c1 <printf+0x11f>
    42a3:	eb 1c                	jmp    42c1 <printf+0x11f>
          putc(fd, *s);
    42a5:	8b 45 f4             	mov    -0xc(%ebp),%eax
    42a8:	0f b6 00             	movzbl (%eax),%eax
    42ab:	0f be c0             	movsbl %al,%eax
    42ae:	89 44 24 04          	mov    %eax,0x4(%esp)
    42b2:	8b 45 08             	mov    0x8(%ebp),%eax
    42b5:	89 04 24             	mov    %eax,(%esp)
    42b8:	e8 05 fe ff ff       	call   40c2 <putc>
          s++;
    42bd:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
    ...
    42c9:	75 da                	jne    42a5 <printf+0x103>
    42cb:	eb 68                	jmp    4335 <printf+0x193>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
    42cd:	83 7d e4 63          	cmpl   $0x63,-0x1c(%ebp)
    42d1:	75 1d                	jne    42f0 <printf+0x14e>
        putc(fd, *ap);
    ...
    42e5:	e8 d8 fd ff ff       	call   40c2 <putc>
        ap++;
    42ea:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    42ee:	eb 45                	jmp    4335 <printf+0x193>
      } else if(c == '%'){
    42f0:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    42f4:	75 17                	jne    430d <printf+0x16b>
        putc(fd, c);
    42f6:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    42f9:	0f be c0             	movsbl %al,%eax
    42fc:	89 44 24 04          	mov    %eax,0x4(%esp)
    4300:	8b 45 08             	mov    0x8(%ebp),%eax
    4303:	89 04 24             	mov    %eax,(%esp)
    4306:	e8 b7 fd ff ff       	call   40c2 <putc>
    430b:	eb 28                	jmp    4335 <printf+0x193>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    430d:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
    4314:	00 
    4315:	8b 45 08             	mov    0x8(%ebp),%eax
    4318:	89 04 24             	mov    %eax,(%esp)
    431b:	e8 a2 fd ff ff       	call   40c2 <putc>
        putc(fd, c);
    4320:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    4323:	0f be c0             	movsbl %al,%eax
    4326:	89 44 24 04          	mov    %eax,0x4(%esp)
    432a:	8b 45 08             	mov    0x8(%ebp),%eax
    432d:	89 04 24             	mov    %eax,(%esp)
    4330:	e8 8d fd ff ff       	call   40c2 <putc>
      }
      state = 0;
    4335:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    433c:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
    4340:	8b 55 0c             	mov    0xc(%ebp),%edx
    4343:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4346:	01 d0                	add    %edx,%eax
    4348:	0f b6 00             	movzbl (%eax),%eax
    434b:	84 c0                	test   %al,%al
    434d:	0f 85 71 fe ff ff    	jne    41c4 <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
    ...
    4358:	83 ec 10             	sub    $0x10,%esp
  Header *bp, *p;

  bp = (Header*)ap - 1;
    435b:	8b 45 08             	mov    0x8(%ebp),%eax
    435e:	83 e8 08             	sub    $0x8,%eax
    4361:	89 45 f8             	mov    %eax,-0x8(%ebp)
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    4364:	a1 e8 66 00 00       	mov    0x66e8,%eax
    4369:	89 45 fc             	mov    %eax,-0x4(%ebp)
    436c:	eb 24                	jmp    4392 <free+0x3d>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    436e:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4371:	8b 00                	mov    (%eax),%eax
    4373:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    4376:	77 12                	ja     438a <free+0x35>
    4378:	8b 45 f8             	mov    -0x8(%ebp),%eax
    437b:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    437e:	77 24                	ja     43a4 <free+0x4f>
    4380:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4383:	8b 00                	mov    (%eax),%eax
    4385:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    4388:	77 1a                	ja     43a4 <free+0x4f>
free(void *ap)
{
  Header *bp, *p;
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    438f:	89 45 fc             	mov    %eax,-0x4(%ebp)
    4392:	8b 45 f8             	mov    -0x8(%ebp),%eax
    4395:	3b 45 fc             	cmp    -0x4(%ebp),%eax
    4398:	76 d4                	jbe    436e <free+0x19>
    439a:	8b 45 fc             	mov    -0x4(%ebp),%eax
    439d:	8b 00                	mov    (%eax),%eax
    439f:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    43a2:	76 ca                	jbe    436e <free+0x19>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    ...
    43b4:	01 c2                	add    %eax,%edx
    43b6:	8b 45 fc             	mov    -0x4(%ebp),%eax
    43b9:	8b 00                	mov    (%eax),%eax
    43bb:	39 c2                	cmp    %eax,%edx
    43bd:	75 24                	jne    43e3 <free+0x8e>
    bp->s.size += p->s.ptr->s.size;
    43bf:	8b 45 f8             	mov    -0x8(%ebp),%eax
    43c2:	8b 50 04             	mov    0x4(%eax),%edx
    43c5:	8b 45 fc             	mov    -0x4(%ebp),%eax
    43c8:	8b 00                	mov    (%eax),%eax
    43ca:	8b 40 04             	mov    0x4(%eax),%eax
    43cd:	01 c2                	add    %eax,%edx
    43cf:	8b 45 f8             	mov    -0x8(%ebp),%eax
    43d2:	89 50 04             	mov    %edx,0x4(%eax)
    bp->s.ptr = p->s.ptr->s.ptr;
    43d5:	8b 45 fc             	mov    -0x4(%ebp),%eax
    43d8:	8b 00                	mov    (%eax),%eax
    43da:	8b 10                	mov    (%eax),%edx
    43dc:	8b 45 f8             	mov    -0x8(%ebp),%eax
    43df:	89 10                	mov    %edx,(%eax)
    43e1:	eb 0a                	jmp    43ed <free+0x98>
  } else
    bp->s.ptr = p->s.ptr;
    43e3:	8b 45 fc             	mov    -0x4(%ebp),%eax
    43e6:	8b 10                	mov    (%eax),%edx
    43e8:	8b 45 f8             	mov    -0x8(%ebp),%eax
    43eb:	89 10                	mov    %edx,(%eax)
  if(p + p->s.size == bp){
    43ed:	8b 45 fc             	mov    -0x4(%ebp),%eax
    43f0:	8b 40 04             	mov    0x4(%eax),%eax
    43f3:	8d 14 c5 00 00 00 00 	lea    0x0(,%eax,8),%edx
    43fa:	8b 45 fc             	mov    -0x4(%ebp),%eax
    43fd:	01 d0                	add    %edx,%eax
    43ff:	3b 45 f8             	cmp    -0x8(%ebp),%eax
    4402:	75 20                	jne    4424 <free+0xcf>
    p->s.size += bp->s.size;
    4404:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4407:	8b 50 04             	mov    0x4(%eax),%edx
    440a:	8b 45 f8             	mov    -0x8(%ebp),%eax
    440d:	8b 40 04             	mov    0x4(%eax),%eax
    4410:	01 c2                	add    %eax,%edx
    4412:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4415:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    4418:	8b 45 f8             	mov    -0x8(%ebp),%eax
    441b:	8b 10                	mov    (%eax),%edx
    441d:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4420:	89 10                	mov    %edx,(%eax)
    4422:	eb 08                	jmp    442c <free+0xd7>
  } else
    p->s.ptr = bp;
    4424:	8b 45 fc             	mov    -0x4(%ebp),%eax
    4427:	8b 55 f8             	mov    -0x8(%ebp),%edx
    442a:	89 10                	mov    %edx,(%eax)
  freep = p;
    442c:	8b 45 fc             	mov    -0x4(%ebp),%eax
    442f:	a3 e8 66 00 00       	mov    %eax,0x66e8
}
    4434:	c9                   	leave  
    4435:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  if(nu < 4096)
    443c:	81 7d 08 ff 0f 00 00 	cmpl   $0xfff,0x8(%ebp)
    4443:	77 07                	ja     444c <morecore+0x16>
    nu = 4096;
    4445:	c7 45 08 00 10 00 00 	movl   $0x1000,0x8(%ebp)
  p = sbrk(nu * sizeof(Header));
    444c:	8b 45 08             	mov    0x8(%ebp),%eax
    444f:	c1 e0 03             	shl    $0x3,%eax
    4452:	89 04 24             	mov    %eax,(%esp)
    4455:	e8 18 fc ff ff       	call   4072 <sbrk>
    445a:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(p == (char*)-1)
    445d:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%ebp)
    4461:	75 07                	jne    446a <morecore+0x34>
    return 0;
    4463:	b8 00 00 00 00       	mov    $0x0,%eax
    4468:	eb 22                	jmp    448c <morecore+0x56>
  hp = (Header*)p;
    446a:	8b 45 f4             	mov    -0xc(%ebp),%eax
    446d:	89 45 f0             	mov    %eax,-0x10(%ebp)
  hp->s.size = nu;
    4470:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4473:	8b 55 08             	mov    0x8(%ebp),%edx
    4476:	89 50 04             	mov    %edx,0x4(%eax)
  free((void*)(hp + 1));
    4479:	8b 45 f0             	mov    -0x10(%ebp),%eax
    447c:	83 c0 08             	add    $0x8,%eax
    447f:	89 04 24             	mov    %eax,(%esp)
    4482:	e8 ce fe ff ff       	call   4355 <free>
  return freep;
    4487:	a1 e8 66 00 00       	mov    0x66e8,%eax
}
    448c:	c9                   	leave  
    448d:	c3                   	ret    
...
malloc(uint nbytes)
{
    ...
    4491:	83 ec 28             	sub    $0x28,%esp
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    4494:	8b 45 08             	mov    0x8(%ebp),%eax
    4497:	83 c0 07             	add    $0x7,%eax
    449a:	c1 e8 03             	shr    $0x3,%eax
    449d:	83 c0 01             	add    $0x1,%eax
    44a0:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
    44a3:	a1 e8 66 00 00       	mov    0x66e8,%eax
    44a8:	89 45 f0             	mov    %eax,-0x10(%ebp)
    44ab:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    44af:	75 23                	jne    44d4 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    44b1:	c7 45 f0 e0 66 00 00 	movl   $0x66e0,-0x10(%ebp)
    44b8:	8b 45 f0             	mov    -0x10(%ebp),%eax
    44bb:	a3 e8 66 00 00       	mov    %eax,0x66e8
    44c0:	a1 e8 66 00 00       	mov    0x66e8,%eax
    44c5:	a3 e0 66 00 00       	mov    %eax,0x66e0
    base.s.size = 0;
    44ca:	c7 05 e4 66 00 00 00 	movl   $0x0,0x66e4
    44d1:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    44d4:	8b 45 f0             	mov    -0x10(%ebp),%eax
    44d7:	8b 00                	mov    (%eax),%eax
    44d9:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(p->s.size >= nunits){
    44dc:	8b 45 f4             	mov    -0xc(%ebp),%eax
    44df:	8b 40 04             	mov    0x4(%eax),%eax
    44e2:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    44e5:	72 4d                	jb     4534 <malloc+0xa6>
      if(p->s.size == nunits)
    44e7:	8b 45 f4             	mov    -0xc(%ebp),%eax
    44ea:	8b 40 04             	mov    0x4(%eax),%eax
    44ed:	3b 45 ec             	cmp    -0x14(%ebp),%eax
    44f0:	75 0c                	jne    44fe <malloc+0x70>
        prevp->s.ptr = p->s.ptr;
    44f2:	8b 45 f4             	mov    -0xc(%ebp),%eax
    44f5:	8b 10                	mov    (%eax),%edx
    44f7:	8b 45 f0             	mov    -0x10(%ebp),%eax
    44fa:	89 10                	mov    %edx,(%eax)
    44fc:	eb 26                	jmp    4524 <malloc+0x96>
      else {
        p->s.size -= nunits;
    44fe:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4501:	8b 40 04             	mov    0x4(%eax),%eax
    4504:	2b 45 ec             	sub    -0x14(%ebp),%eax
    4507:	89 c2                	mov    %eax,%edx
    4509:	8b 45 f4             	mov    -0xc(%ebp),%eax
    450c:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
    450f:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4512:	8b 40 04             	mov    0x4(%eax),%eax
    4515:	c1 e0 03             	shl    $0x3,%eax
    4518:	01 45 f4             	add    %eax,-0xc(%ebp)
        p->s.size = nunits;
    451b:	8b 45 f4             	mov    -0xc(%ebp),%eax
    451e:	8b 55 ec             	mov    -0x14(%ebp),%edx
    4521:	89 50 04             	mov    %edx,0x4(%eax)
      }
      freep = prevp;
    4524:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4527:	a3 e8 66 00 00       	mov    %eax,0x66e8
      return (void*)(p + 1);
    452c:	8b 45 f4             	mov    -0xc(%ebp),%eax
    452f:	83 c0 08             	add    $0x8,%eax
    4532:	eb 38                	jmp    456c <malloc+0xde>
    }
    if(p == freep)
    4534:	a1 e8 66 00 00       	mov    0x66e8,%eax
    4539:	39 45 f4             	cmp    %eax,-0xc(%ebp)
    453c:	75 1b                	jne    4559 <malloc+0xcb>
      if((p = morecore(nunits)) == 0)
    453e:	8b 45 ec             	mov    -0x14(%ebp),%eax
    4541:	89 04 24             	mov    %eax,(%esp)
    4544:	e8 ed fe ff ff       	call   4436 <morecore>
    4549:	89 45 f4             	mov    %eax,-0xc(%ebp)
    454c:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    4550:	75 07                	jne    4559 <malloc+0xcb>
        return 0;
    4552:	b8 00 00 00 00       	mov    $0x0,%eax
    4557:	eb 13                	jmp    456c <malloc+0xde>
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    455c:	89 45 f0             	mov    %eax,-0x10(%ebp)
    ...
    4567:	e9 70 ff ff ff       	jmp    44dc <malloc+0x4e>
}
    456c:	c9                   	leave  
    456d:	c3                   	ret    

0000456e <thread_create>:
#include"x86.h"
#include"param.h"
#include"proc.h"
...
int thread_create(thread_t *thread, void*(*start_routine)(void*),void *arg)
{
    ...
    4571:	83 ec 28             	sub    $0x28,%esp
    void *stack = malloc(PGSIZE);
    4574:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
    457b:	e8 0e ff ff ff       	call   448e <malloc>
    4580:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if((uint)stack <=0)
    4583:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4586:	85 c0                	test   %eax,%eax
    4588:	75 1b                	jne    45a5 <thread_create+0x37>
    {
        printf(1,"malloc thread stack failed\n");
    458a:	c7 44 24 04 99 5e 00 	movl   $0x5e99,0x4(%esp)
    4591:	00 
    4592:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    4599:	e8 04 fc ff ff       	call   41a2 <printf>
        return -1;
    459e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
    45a3:	eb 67                	jmp    460c <thread_create+0x9e>
    }
    
    if((uint)stack%PGSIZE)
    45a5:	8b 45 f4             	mov    -0xc(%ebp),%eax
    45a8:	25 ff 0f 00 00       	and    $0xfff,%eax
    45ad:	85 c0                	test   %eax,%eax
    45af:	74 14                	je     45c5 <thread_create+0x57>
        stack += PGSIZE-((uint)stack%PGSIZE);
    45b1:	8b 45 f4             	mov    -0xc(%ebp),%eax
    45b4:	25 ff 0f 00 00       	and    $0xfff,%eax
    45b9:	89 c2                	mov    %eax,%edx
    45bb:	b8 00 10 00 00       	mov    $0x1000,%eax
    45c0:	29 d0                	sub    %edx,%eax
    45c2:	01 45 f4             	add    %eax,-0xc(%ebp)
    printf(1,"1\n");
    45c5:	c7 44 24 04 b5 5e 00 	movl   $0x5eb5,0x4(%esp)
    45cc:	00 
    45cd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    45d4:	e8 c9 fb ff ff       	call   41a2 <printf>
    if((*thread = clone(start_routine,arg,stack))<0)
    45d9:	8b 45 f4             	mov    -0xc(%ebp),%eax
    45dc:	89 44 24 08          	mov    %eax,0x8(%esp)
    45e0:	8b 45 10             	mov    0x10(%ebp),%eax
    45e3:	89 44 24 04          	mov    %eax,0x4(%esp)
    45e7:	8b 45 0c             	mov    0xc(%ebp),%eax
    45ea:	89 04 24             	mov    %eax,(%esp)
    45ed:	e8 b8 fa ff ff       	call   40aa <clone>
    45f2:	8b 55 08             	mov    0x8(%ebp),%edx
    45f5:	89 02                	mov    %eax,(%edx)
    45f7:	8b 45 08             	mov    0x8(%ebp),%eax
    45fa:	8b 00                	mov    (%eax),%eax
    45fc:	85 c0                	test   %eax,%eax
    45fe:	79 07                	jns    4607 <thread_create+0x99>
        return -1;
    4600:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
    4605:	eb 05                	jmp    460c <thread_create+0x9e>
    return 0;
...
0000460e <thread_join>:

int thread_join(thread_t thread, void **retval)
{
    460e:	55                   	push   %ebp
    460f:	89 e5                	mov    %esp,%ebp
    4611:	83 ec 28             	sub    $0x28,%esp
    void *stack;
    if(join((uint)thread, &stack, retval)<0)
    4614:	8b 45 0c             	mov    0xc(%ebp),%eax
    4617:	89 44 24 08          	mov    %eax,0x8(%esp)
    461b:	8d 45 f4             	lea    -0xc(%ebp),%eax
    461e:	89 44 24 04          	mov    %eax,0x4(%esp)
    4622:	8b 45 08             	mov    0x8(%ebp),%eax
    4625:	89 04 24             	mov    %eax,(%esp)
    4628:	e8 85 fa ff ff       	call   40b2 <join>
    462d:	85 c0                	test   %eax,%eax
    462f:	79 07                	jns    4638 <thread_join+0x2a>
        return -1;
    4631:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
    4636:	eb 10                	jmp    4648 <thread_join+0x3a>

    free(stack);
    4638:	8b 45 f4             	mov    -0xc(%ebp),%eax
    463b:	89 04 24             	mov    %eax,(%esp)
    463e:	e8 12 fd ff ff       	call   4355 <free>
    return 0;
    4643:	b8 00 00 00 00       	mov    $0x0,%eax
}
    4648:	c9                   	leave  
    4649:	c3                   	ret    

0000464a <thread_exit>:

void thread_exit(void *retval)
{
    464a:	55                   	push   %ebp
    464b:	89 e5                	mov    %esp,%ebp
    464d:	83 ec 08             	sub    $0x8,%esp
    proc->retval = retval;
    4650:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
    4656:	8b 55 08             	mov    0x8(%ebp),%edx
    4659:	89 90 88 00 00 00    	mov    %edx,0x88(%eax)
    thexit();
    465f:	e8 56 fa ff ff       	call   40ba <thexit>
}
    4664:	c9                   	leave  
    4665:	c3                   	ret    
