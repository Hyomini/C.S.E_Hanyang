...
main(int argc, char *argv[])
{
  ...
  if(argc < 2){
   ...
   f:	c7 44 24 04 73 09 00 	movl   $0x973,0x4(%esp)
  16:	00 
  ...
  66:	c7 44 24 04 8a 09 00 	movl   $0x98a,0x4(%esp)
  6d:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 448:	0f b6 80 70 0c 00 00 	movzbl 0xc70(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 5a5:	75 09                	jne    5b0 <printf+0x101>
          s = "(null)";
 5a7:	c7 45 f4 a6 09 00 00 	movl   $0x9a6,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 671:	a1 8c 0c 00 00       	mov    0xc8c,%eax
...
free(void *ap)
{
 ...
 73c:	a3 8c 0c 00 00       	mov    %eax,0xc8c
}
 741:	c9                   	leave  
 742:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 78f:	e8 ce fe ff ff       	call   662 <free>
  return freep;
 794:	a1 8c 0c 00 00       	mov    0xc8c,%eax
}
 799:	c9                   	leave  
 79a:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 7ad:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 7b0:	a1 8c 0c 00 00       	mov    0xc8c,%eax
 7b5:	89 45 f0             	mov    %eax,-0x10(%ebp)
 7b8:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 7bc:	75 23                	jne    7e1 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 7be:	c7 45 f0 84 0c 00 00 	movl   $0xc84,-0x10(%ebp)
 7c5:	8b 45 f0             	mov    -0x10(%ebp),%eax
 7c8:	a3 8c 0c 00 00       	mov    %eax,0xc8c
 7cd:	a1 8c 0c 00 00       	mov    0xc8c,%eax
 7d2:	a3 84 0c 00 00       	mov    %eax,0xc84
    base.s.size = 0;
 7d7:	c7 05 88 0c 00 00 00 	movl   $0x0,0xc88
 7de:	00 00 00 
  }
 ...
 834:	a3 8c 0c 00 00       	mov    %eax,0xc8c
      return (void*)(p + 1);
 ...
 83f:	eb 38                	jmp    879 <malloc+0xde>
    ...
    if(p == freep)
 841:	a1 8c 0c 00 00       	mov    0xc8c,%eax
...
int thread_join(thread_t thread, void **retval)
{
 ...
 935:	e8 85 fa ff ff       	call   3bf <join>
 93a:	85 c0                	test   %eax,%eax
 93c:	79 07                	jns    945 <thread_join+0x2a>
        return -1;
 93e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 943:	eb 10                	jmp    955 <thread_join+0x3a>

    free(stack);
 945:	8b 45 f4             	mov    -0xc(%ebp),%eax
 948:	89 04 24             	mov    %eax,(%esp)
 94b:	e8 12 fd ff ff       	call   662 <free>
    return 0;
...
void thread_exit(void *retval)
{
 ...
 95a:	83 ec 08             	sub    $0x8,%esp
    proc->retval = retval;
 95d:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
 963:	8b 55 08             	mov    0x8(%ebp),%edx
 966:	89 90 88 00 00 00    	mov    %edx,0x88(%eax)
    thexit();
 96c:	e8 56 fa ff ff       	call   3c7 <thexit>
}
 971:	c9                   	leave  
 972:	c3                   	ret    
