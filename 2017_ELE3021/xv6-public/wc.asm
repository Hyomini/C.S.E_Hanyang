...
wc(int fd, char *name)
{
  ...
  54:	c7 04 24 bd 0a 00 00 	movl   $0xabd,(%esp)
  ...
  91:	00 
  92:	c7 44 24 04 20 0e 00 	movl   $0xe20,0x4(%esp)
  99:	00 
  ...
  b8:	c7 44 24 04 c3 0a 00 	movl   $0xac3,0x4(%esp)
  bf:	00 
  ...
  ed:	c7 44 24 04 d3 0a 00 	movl   $0xad3,0x4(%esp)
  f4:	00 
...
main(int argc, char *argv[])
{
 ...
 110:	7f 19                	jg     12b <main+0x28>
    wc(0, "");
 112:	c7 44 24 04 e0 0a 00 	movl   $0xae0,0x4(%esp)
 119:	00 
 ...
 17b:	c7 44 24 04 e1 0a 00 	movl   $0xae1,0x4(%esp)
 182:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 592:	0f b6 80 e0 0d 00 00 	movzbl 0xde0(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 6ef:	75 09                	jne    6fa <printf+0x101>
          s = "(null)";
 6f1:	c7 45 f4 f5 0a 00 00 	movl   $0xaf5,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 7bb:	a1 08 0e 00 00       	mov    0xe08,%eax
...
free(void *ap)
{
 ...
 886:	a3 08 0e 00 00       	mov    %eax,0xe08
}
 88b:	c9                   	leave  
 88c:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 8d9:	e8 ce fe ff ff       	call   7ac <free>
  return freep;
 8de:	a1 08 0e 00 00       	mov    0xe08,%eax
}
 8e3:	c9                   	leave  
 8e4:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 8f7:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 8fa:	a1 08 0e 00 00       	mov    0xe08,%eax
 8ff:	89 45 f0             	mov    %eax,-0x10(%ebp)
 902:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 906:	75 23                	jne    92b <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 908:	c7 45 f0 00 0e 00 00 	movl   $0xe00,-0x10(%ebp)
 90f:	8b 45 f0             	mov    -0x10(%ebp),%eax
 912:	a3 08 0e 00 00       	mov    %eax,0xe08
 917:	a1 08 0e 00 00       	mov    0xe08,%eax
 91c:	a3 00 0e 00 00       	mov    %eax,0xe00
    base.s.size = 0;
 921:	c7 05 04 0e 00 00 00 	movl   $0x0,0xe04
 928:	00 00 00 
  }
 ...
 97e:	a3 08 0e 00 00       	mov    %eax,0xe08
      return (void*)(p + 1);
 ...
 989:	eb 38                	jmp    9c3 <malloc+0xde>
    ...
    if(p == freep)
 98b:	a1 08 0e 00 00       	mov    0xe08,%eax
...
int thread_create(thread_t *thread, void*(*start_routine)(void*),void *arg)
{
 ...
 9cb:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
 9d2:	e8 0e ff ff ff       	call   8e5 <malloc>
 9d7:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if((uint)stack <=0)
 9da:	8b 45 f4             	mov    -0xc(%ebp),%eax
 9dd:	85 c0                	test   %eax,%eax
 9df:	75 1b                	jne    9fc <thread_create+0x37>
    {
        printf(1,"malloc thread stack failed\n");
 9e1:	c7 44 24 04 fc 0a 00 	movl   $0xafc,0x4(%esp)
 9e8:	00 
 9e9:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 9f0:	e8 04 fc ff ff       	call   5f9 <printf>
        return -1;
 9f5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 9fa:	eb 67                	jmp    a63 <thread_create+0x9e>
    }
 ...
 a06:	74 14                	je     a1c <thread_create+0x57>
        stack += PGSIZE-((uint)stack%PGSIZE);
 a08:	8b 45 f4             	mov    -0xc(%ebp),%eax
 a0b:	25 ff 0f 00 00       	and    $0xfff,%eax
 a10:	89 c2                	mov    %eax,%edx
 a12:	b8 00 10 00 00       	mov    $0x1000,%eax
 a17:	29 d0                	sub    %edx,%eax
 a19:	01 45 f4             	add    %eax,-0xc(%ebp)
    printf(1,"1\n");
 a1c:	c7 44 24 04 18 0b 00 	movl   $0xb18,0x4(%esp)
 a23:	00 
 a24:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 a2b:	e8 c9 fb ff ff       	call   5f9 <printf>
    if((*thread = clone(start_routine,arg,stack))<0)
 a30:	8b 45 f4             	mov    -0xc(%ebp),%eax
 a33:	89 44 24 08          	mov    %eax,0x8(%esp)
 a37:	8b 45 10             	mov    0x10(%ebp),%eax
 a3a:	89 44 24 04          	mov    %eax,0x4(%esp)
 a3e:	8b 45 0c             	mov    0xc(%ebp),%eax
 a41:	89 04 24             	mov    %eax,(%esp)
 a44:	e8 b8 fa ff ff       	call   501 <clone>
 a49:	8b 55 08             	mov    0x8(%ebp),%edx
 a4c:	89 02                	mov    %eax,(%edx)
 a4e:	8b 45 08             	mov    0x8(%ebp),%eax
 a51:	8b 00                	mov    (%eax),%eax
 a53:	85 c0                	test   %eax,%eax
 a55:	79 07                	jns    a5e <thread_create+0x99>
        return -1;
 a57:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
 a5c:	eb 05                	jmp    a63 <thread_create+0x9e>
    return 0;
...
void thread_exit(void *retval)
{
 ...
 aa4:	83 ec 08             	sub    $0x8,%esp
    proc->retval = retval;
 aa7:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
 aad:	8b 55 08             	mov    0x8(%ebp),%edx
 ab0:	89 90 88 00 00 00    	mov    %edx,0x88(%eax)
    thexit();
 ab6:	e8 56 fa ff ff       	call   511 <thexit>
}
 abb:	c9                   	leave  
 abc:	c3                   	ret    
